...
#include <dt-bindings/realtek/clock/realtek-amebad2-clock.h>
#ifdef CONFIG_RESET_CONTROLLER
#include <dt-bindings/realtek/reset/realtek-amebad2-reset.h>
#endif

#include "rcc-realtek.h"
#include "rcc-amebad2.h"
...
#ifdef CONFIG_RESET_CONTROLLER
static DEFINE_SPINLOCK(amebad2_reset_lock);
#endif
...
static const char *cksl_adc_parents[2]			= {"CKE_XTAL_GRP2", "OSC_4M"};
...
static const char *cksl_loguart2m_parents[2]	= {"OSC_4M", "CKE_XTAL_GRP2"};
...
static const char *cksl_uart2m_parents[2]		= {"OSC_4M", "CKE_XTAL_GRP2"};
...
static const char *cksl_adc2m_parents[2]		= {"OSC_4M", "CKE_XTAL_GRP2"};
...
RTK_GATE_CLK(aon_gate_timer,									"CKE_ATIM",				"OSC_100K",
			 AMEBAD2_REG_AON_CLK,	CKE_ATIM,					RTK_NO_GATE_FLAGS,		AMEBAD2_REG_AON_FEN,	FEN_ATIM,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(aon_gate_rtc,										"CKE_RTC",				"CKSL_32K",
			 AMEBAD2_REG_AON_CLK,	CKE_RTC,					RTK_NO_GATE_FLAGS,		AMEBAD2_REG_AON_FEN,	FEN_RTC,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(aon_gate_sdm_32k,									"CKE_SDM32K",			"CKSL_SDM",
			 AMEBAD2_REG_AON_CLK,	CKE_SDM32K,					RTK_NO_GATE_FLAGS,		AMEBAD2_REG_AON_FEN,	FEN_SDM32K,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(aon_gate_lp4m,										"CKE_LP4M",				"OSC_4M",
			 AMEBAD2_REG_AON_CLK,	CKE_LP4M,					RTK_NO_GATE_FLAGS,		0,						0,				CLK_IGNORE_UNUSED);
RTK_GATE_CLK(aon_gate_osc4m_force0,								"CKE_OSC4M_FORCE0",		"OSC_4M",
			 AMEBAD2_REG_AON_CLK,	CKE_OSC4M_FORCE0,			RTK_NO_GATE_FLAGS,		0,						0,				CLK_IGNORE_UNUSED);
RTK_GATE_CLK(aon_gate_osc4m_force1,								"CKE_OSC4M_FORCE1",		"OSC_4M",
			 AMEBAD2_REG_AON_CLK,	CKE_OSC4M_FORCE1,			RTK_NO_GATE_FLAGS,		0,						0,				CLK_IGNORE_UNUSED);
RTK_GATE_CLK(aon_gate_osc4m_force2,								"CKE_OSC4M_FORCE2",		"OSC_4M",
			 AMEBAD2_REG_AON_CLK,	CKE_OSC4M_FORCE2,			RTK_NO_GATE_FLAGS,		0,						0,				CLK_IGNORE_UNUSED);
RTK_GATE_CLK(aon_gate_osc4m_force3,								"CKE_OSC4M_FORCE3",		"OSC_4M",
			 AMEBAD2_REG_AON_CLK,	CKE_OSC4M_FORCE3,			RTK_NO_GATE_FLAGS,		0,						0,				CLK_IGNORE_UNUSED);
RTK_GATE_CLK(aon_gate_osc4m_force4,								"CKE_OSC4M_FORCE4",		"OSC_4M",
			 AMEBAD2_REG_AON_CLK,	CKE_OSC4M_FORCE4,			RTK_NO_GATE_FLAGS,		0,						0,				CLK_IGNORE_UNUSED);
RTK_GATE_CLK(aon_gate_osc4m_force5,								"CKE_OSC4M_FORCE5",		"OSC_4M",
			 AMEBAD2_REG_AON_CLK,	CKE_OSC4M_FORCE5,			RTK_NO_GATE_FLAGS,		0,						0,				CLK_IGNORE_UNUSED);
RTK_GATE_CLK(aon_gate_osc4m_force6,								"CKE_OSC4M_FORCE6",		"OSC_4M",
			 AMEBAD2_REG_AON_CLK,	CKE_OSC4M_FORCE6,			RTK_NO_GATE_FLAGS,		0,						0,				CLK_IGNORE_UNUSED);
RTK_GATE_CLK(aon_gate_osc4m_force7,								"CKE_OSC4M_FORCE7",		"OSC_4M",
			 AMEBAD2_REG_AON_CLK,	CKE_OSC4M_FORCE7,			RTK_NO_GATE_FLAGS,		0,						0,				CLK_IGNORE_UNUSED);

RTK_MUX_CLK(aon_mux_otp,										"CKSL_OTP",				cksl_otp_parents,
			AMEBAD2_REG_AON_CKSL,	CKSL_OTP_SHIFT,				CKSL_OTP_MASK,			RTK_NO_MUX_FLAGS,		RTK_NO_FLAGS);
RTK_MUX_CLK(aon_mux_32k,										"CKSL_32K",				cksl_32k_parents,
			AMEBAD2_REG_AON_CKSL,	CKSL_32K_SHIFT,				CKSL_32K_MASK,			RTK_NO_MUX_FLAGS,		RTK_NO_FLAGS);

/* LSYS clocks */

RTK_GATE_CLK(lsys_gate_hpon,									"CKE_HPON",				"HAPB_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_HPON,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_HPON,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_sic,										"CKE_SIC",				"LBUS_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_SIC,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_SIC,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_lplfm,									"CKE_LPLFM",			"CKE_XTAL_GRP0",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_LPLFM,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_LPLFM,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_hplfm,									"CKE_HPLFM",			"CKE_XTAL_GRP1",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_HPLFM,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_HPLFM,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_lp,										"CKE_LP",				"LBUS_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_LP,					RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_LP,			CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_np,										"CKE_NP",				"CKSL_NP",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_NP,					RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_NP,			CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_spic,									"CKE_SPIC",				"CKSL_SPIC",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_SPIC,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_SPIC,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_gpio,									"CKE_GPIO",				"CKSL_GPIO",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_GPIO,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_GPIO,		CLK_IGNORE_UNUSED);
/*
RTK_GATE_CLK(lsys_gate_wlon,									"CKE_WLON",				NULL,	// TBD
	AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_WLON,						RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_WLON,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_bton,									"CKE_BTON",				NULL,	// TBD
	AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_BTON,						RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_BTON,		CLK_IGNORE_UNUSED);
*/
RTK_GATE_CLK(lsys_gate_px,										"CKE_PX",				"CKE_LP4M",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_PX,					RTK_NO_GATE_FLAGS,		AMEBAD2_REG_AON_FEN,		FEN_PX,			CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_ipc_lp,									"CKE_IPC_LP",			"CKE_LP4M",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_IPC_LP,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_IPC_LP,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_loguart,									"CKE_LOGUART",			"CKSL_LOGUART",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_LOGUART,			RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_LOGUART,	CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_ctc,										"CKE_CTC",				"CKSL_CTC",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_CTC,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_CTC,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_adc,										"CKE_ADC",				"CKSL_ADC",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_ADC,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_ADC,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_thm,										"CKE_THM",				"LAPB_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_THM,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_THM,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_aip,										"CKE_AIP",				"OSC_4M",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_AIP,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_AIP,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_ed25519,									"CKE_ED25519",			"CKE_HPERI",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_ED25519,			RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_ED25519,	CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_ecdsa,									"CKE_ECDSA",			"CKE_HPERI",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_AIP,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_ECDSA,		CLK_IGNORE_UNUSED);
/*
RTK_GATE_CLK(lsys_gate_dtim,									"CKE_DTIM",				NULL,	// TBD: the parent clk is acutally a mux(CKSL_32K, CKE_XTAL_GRP0) within DTIM
	AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_DTIM,						RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_DTIM,		CLK_IGNORE_UNUSED);
*/
RTK_GATE_CLK(lsys_gate_i2c0,									"CKE_I2C0",				"LAPB_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_I2C0,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_I2C0,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_i2c1,									"CKE_I2C1",				"HBUS_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_I2C1,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_I2C1,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_i2c2,									"CKE_I2C2",				"HBUS_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP0,	CKE_I2C2,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP0,	FEN_I2C2,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_hperi,									"CKE_HPERI",			"CKD_HPERI",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_HPERI,				RTK_NO_GATE_FLAGS,		0,							0,				CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_lx1,										"CKE_LX1",				"HBUS_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_LX1,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_LX1,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_ipsec,									"CKE_IPSEC",			"HBUS_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_IPSEC,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_IPSEC,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_lcdcmipi,								"CKE_LCDCMIPI",			"CKE_HPERI",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_LCDCMIPI,			RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_LCDC,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_gdma,									"CKE_GDMA",				"HBUS_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_GDMA,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_GDMA,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_wmac,									"CKE_WMAC",				"HBUS_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_WMAC,				RTK_NO_GATE_FLAGS,		0,							0,				CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_spi0,									"CKE_SPI0",				"HBUS_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_SPI0,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_SPI0,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_spi1,									"CKE_SPI1",				"HBUS_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_SPI1,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_SPI1,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_usb,										"CKE_USB",				"HBUS_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_USB,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_USB,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_ledc,									"CKE_LEDC",				"CKE_XTAL_GRP1",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_LEDC,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_LEDC,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_trng,									"CKE_TRNG",				"NP_SYSPLL",	// NP_SYSPLL_G8, div=1
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_TRNG,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_TRNG,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_sdh,										"CKE_SDH",				"CKE_HPERI",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_SDH,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_SDH,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_ipc_hp,									"CKE_IPC_HP",			"HAPB_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_IPC_HP,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_IPC_HP,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_irda,									"CKE_IRDA",				"HBUS_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_IRDA,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_IRDA,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_ddrc,									"CKE_DDRC",				"DDR_PLL_533M",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_DDRC,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_DDRC,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_ddrp,									"CKE_DDRP",				"DDR_PLL_533M",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_DDRP,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_DDRP,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_ac,										"CKE_AC",				"CKSL_AC",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_AC,					RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_AC,			CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_psram,									"CKE_PSRAM",			"CKSL_PSRAM",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_PSRAM,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_PSRAM,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_zgb,										"CKE_ZGB",				"HBUS_CLK",
			 AMEBAD2_REG_LSYS_CKE_GRP1,	CKE_ZGB,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP1,	FEN_ZGB,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_uart0,									"CKE_UART0",			"CKSL_UART0",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_UART0,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_UART0,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_uart1,									"CKE_UART1",			"CKSL_UART1",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_UART1,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_UART1,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_uart2,									"CKE_UART2",			"CKSL_UART2",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_UART2,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_UART2,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_uart3,									"CKE_UART3",			"CKSL_UART3",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_UART3,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_UART3,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_sport0,									"CKE_SPORT0",			"CKSL_SPORT0",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_SPORT0,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_SPORT0,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_sport1,									"CKE_SPORT1",			"CKSL_SPORT1",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_SPORT1,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_SPORT1,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_sport2,									"CKE_SPORT2",			"CKSL_SPORT2",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_SPORT2,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_SPORT2,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_sport3,									"CKE_SPORT3",			"CKSL_SPORT3",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_SPORT3,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_SPORT3,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_tim0,									"CKE_TIM0",				"CKSL_32K",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_TIM0,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_TIM0,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_tim1,									"CKE_TIM1",				"CKSL_32K",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_TIM1,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_TIM1,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_tim2,									"CKE_TIM2",				"CKSL_32K",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_TIM2,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_TIM2,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_tim3,									"CKE_TIM3",				"CKSL_32K",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_TIM3,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_TIM3,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_tim4,									"CKE_TIM4",				"CKSL_32K",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_TIM4,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_TIM4,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_tim5,									"CKE_TIM5",				"CKSL_32K",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_TIM5,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_TIM5,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_tim6,									"CKE_TIM6",				"CKSL_32K",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_TIM6,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_TIM6,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_tim7,									"CKE_TIM7",				"CKSL_32K",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_TIM7,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_TIM7,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_tim8,									"CKE_TIM8",				"CKSL_32K",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_TIM8,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_TIM8,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_tim9,									"CKE_TIM9",				"CKSL_32K",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_TIM9,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_TIM9,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_tim10,									"CKE_TIM10",			"CKSL_32K",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_TIM10,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_TIM10,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_tim11,									"CKE_TIM11",			"CKSL_32K",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_TIM11,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_TIM11,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_tim12,									"CKE_TIM12",			"CKSL_32K",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_TIM12,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_TIM12,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_tim13,									"CKE_TIM13",			"CKSL_32K",
			 AMEBAD2_REG_LSYS_CKE_GRP2,	CKE_TIM13,				RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_FEN_GRP2,	FEN_TIM13,		CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_xtal_grp0,								"CKE_XTAL_GRP0",		"XTAL_40M",
			 AMEBAD2_REG_LSYS_CKE_GRP,	CKE_XTAL_GRP0,			RTK_NO_GATE_FLAGS,		0,							0,				CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_xtal_grp1,								"CKE_XTAL_GRP1",		"XTAL_40M",
			 AMEBAD2_REG_LSYS_CKE_GRP,	CKE_XTAL_GRP0,			RTK_NO_GATE_FLAGS,		0,							0,				CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_xtal_grp2,								"CKE_XTAL_GRP2",		"XTAL_40M",
			 AMEBAD2_REG_LSYS_CKE_GRP,	CKE_XTAL_GRP0,			RTK_NO_GATE_FLAGS,		AMEBAD2_REG_LSYS_CKD_GRP1,	CKD_XTAL_2M_EN,	CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_xtal_grp3,								"CKE_XTAL_GRP3",		"XTAL_40M",
			 AMEBAD2_REG_LSYS_CKE_GRP,	CKE_XTAL_GRP0,			RTK_NO_GATE_FLAGS,		0,							0,				CLK_IGNORE_UNUSED);
RTK_GATE_CLK(lsys_gate_xtal_lps_grp0,							"CKE_XTAL_LPS_GRP0",	"XTAL_LPS",
			 AMEBAD2_REG_LSYS_CKE_GRP,	CKE_XTAL_LPS_GRP0,		RTK_NO_GATE_FLAGS,		0,							0,				CLK_IGNORE_UNUSED);
...
RTK_MUX_CLK(lsys_mux_lsoc,										"CKSL_LSOC",			cksl_lsoc_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_LSOC_SHIFT,		CKSL_LSOC_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_spic,										"CKSL_SPIC",			cksl_spic_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_SPIC_SHIFT,		CKSL_SPIC_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_gpio,										"CKSL_GPIO",			cksl_gpio_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_GPIO_SHIFT,		CKSL_GPIO_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_adc,										"CKSL_ADC",				cksl_adc_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_ADC_SHIFT,			CKSL_ADC_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_ctc,										"CKSL_CTC",				cksl_ctc_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_CTC_SHIFT,			CKSL_CTC_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_np,										"CKSL_NP",				cksl_np_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_NP_SHIFT,			CKSL_NP_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_hbus,										"CKSL_HBUS",			cksl_hbus_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_HBUS_SHIFT,		CKSL_HBUS_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_loguart,									"CKSL_LOGUART",			cksl_loguart_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_LOGUART_SHIFT,		CKSL_LOGUART_MASK,		RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_loguart2m,									"CKSL_LOGUART2M",		cksl_loguart2m_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_LOGUART2M_SHIFT,	CKSL_LOGUART2M_MASK,	RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_ac,										"CKSL_AC",				cksl_ac_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_AC_SHIFT,			CKSL_AC_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_vadm,										"CKSL_VADM",			cksl_vadm_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_VADM_SHIFT,		CKSL_VADM_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_sdm,										"CKSL_SDM",				cksl_sdm_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_SDM_SHIFT,			CKSL_SDM_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_uart0,										"CKSL_UART0",			cksl_uart_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_UART0_SHIFT,		CKSL_UART0_MASK,		RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_uart1,										"CKSL_UART1",			cksl_uart_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_UART1_SHIFT,		CKSL_UART1_MASK,		RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_uart2,										"CKSL_UART2",			cksl_uart_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_UART2_SHIFT,		CKSL_UART2_MASK,		RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_uart2m,									"CKSL_UART2M",			cksl_uart2m_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_UART2M_SHIFT,		CKSL_UART2M_MASK,		RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_sport0,									"CKSL_SPORT0",			cksl_sport0_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_SPORT0_SHIFT,		CKSL_SPORT0_MASK,		RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_sport1,									"CKSL_SPORT1",			cksl_sport1_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_SPORT1_SHIFT,		CKSL_SPORT1_MASK,		RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_sport2,									"CKSL_SPORT2",			cksl_sport2_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_SPORT2_SHIFT,		CKSL_SPORT2_MASK,		RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_sport3,									"CKSL_SPORT3",			cksl_sport3_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_SPORT3_SHIFT,		CKSL_SPORT3_MASK,		RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_adc2m,										"CKSL_ADC2M",			cksl_adc2m_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_ADC2M_SHIFT,		CKSL_ADC2M_MASK,		RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_vad,										"CKSL_VAD",				cksl_vad_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_VAD_SHIFT,			CKSL_VAD_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_hipc,										"CKSL_HIPC",			cksl_hipc_parents,
			AMEBAD2_REG_LSYS_CKSL_GRP0,	CKSL_HIPC_SHIFT,		CKSL_HIPC_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
...
RTK_DIV_CLK(lsys_div_np,										"CKD_NP",				"NP_SYSPLL",	// NP_SYSPLL_G0
			AMEBAD2_REG_LSYS_CKD_GRP0,	CKD_NP_SHIFT,			CKD_NP_WIDTH,			RTK_NO_DIV_TABLE,			RTK_NO_DIV_FLAGS,			RTK_NO_FLAGS);
RTK_DIV_CLK(lsys_div_plfm,										"CKD_PLFM",				"CKSL_NP",
			AMEBAD2_REG_LSYS_CKD_GRP0,	CKD_PLFM_SHIFT,			CKD_PLFM_WIDTH,			RTK_NO_DIV_TABLE,			RTK_NO_DIV_FLAGS,			RTK_NO_FLAGS);
...
RTK_DIV_CLK(lsys_div_ac,										"CKD_AC",				"NP_SYSPLL",	// NP_SYSPLL_G7
			AMEBAD2_REG_LSYS_CKD_GRP0,	CKD_AC_SHIFT,			CKD_AC_WIDTH,			ckd_ac_div_table,			RTK_NO_DIV_FLAGS,			RTK_NO_FLAGS);
RTK_DIV_CLK(lsys_div_hperi,										"CKD_HPERI",			"NP_SYSPLL",	// NP_SYSPLL_G6
			AMEBAD2_REG_LSYS_CKD_GRP0,	CKD_HPERI_SHIFT,		CKD_HPERI_WIDTH,		RTK_NO_DIV_TABLE,			RTK_NO_DIV_FLAGS,			RTK_NO_FLAGS);
RTK_DIV_CLK(lsys_div_mipi,										"CKD_MIPI",				"NP_SYSPLL",
			AMEBAD2_REG_LSYS_CKD_GRP0,	CKD_MIPI_SHIFT,			CKD_MIPI_WIDTH,			RTK_NO_DIV_TABLE,			RTK_NO_DIV_FLAGS,			RTK_NO_FLAGS);

RTK_MUX_CLK(lsys_mux_i2s0,										"CKSL_I2S0",			cksl_i2s_parents,
			AMEBAD2_REG_SPORT_CLK,		CKSL_I2S0_SHIFT,		CKSL_I2S0_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_i2s1,										"CKSL_I2S1",			cksl_i2s_parents,
			AMEBAD2_REG_SPORT_CLK,		CKSL_I2S1_SHIFT,		CKSL_I2S1_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_i2s2,										"CKSL_I2S2",			cksl_i2s_parents,
			AMEBAD2_REG_SPORT_CLK,		CKSL_I2S2_SHIFT,		CKSL_I2S2_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_MUX_CLK(lsys_mux_i2s3,										"CKSL_I2S3",			cksl_i2s_parents,
			AMEBAD2_REG_SPORT_CLK,		CKSL_I2S3_SHIFT,		CKSL_I2S3_MASK,			RTK_NO_MUX_FLAGS,			RTK_NO_FLAGS);
RTK_DIV_CLK(lsys_div_sport0,									"CKD_SPORT0",			"CKSL_I2S0",
			AMEBAD2_REG_SPORT_CLK,		CKD_SPORT0_SHIFT,		CKD_SPORT0_WIDTH,		RTK_NO_DIV_TABLE,			RTK_NO_DIV_FLAGS,			RTK_NO_FLAGS);
RTK_DIV_CLK(lsys_div_sport1,									"CKD_SPORT1",			"CKSL_I2S1",
			AMEBAD2_REG_SPORT_CLK,		CKD_SPORT1_SHIFT,		CKD_SPORT1_WIDTH,		RTK_NO_DIV_TABLE,			RTK_NO_DIV_FLAGS,			RTK_NO_FLAGS);
RTK_DIV_CLK(lsys_div_sport2,									"CKD_SPORT2",			"CKSL_I2S2",
			AMEBAD2_REG_SPORT_CLK,		CKD_SPORT2_SHIFT,		CKD_SPORT2_WIDTH,		RTK_NO_DIV_TABLE,			RTK_NO_DIV_FLAGS,			RTK_NO_FLAGS);
RTK_DIV_CLK(lsys_div_sport3,									"CKD_SPORT3",			"CKSL_I2S3",
			AMEBAD2_REG_SPORT_CLK,		CKD_SPORT3_SHIFT,		CKD_SPORT3_WIDTH,		RTK_NO_DIV_TABLE,			RTK_NO_DIV_FLAGS,			RTK_NO_FLAGS);
...
#ifdef CONFIG_RESET_CONTROLLER
static const struct rtk_reset_map amebad2_reset_map[] = {
	[RTK_POR_SYSON]				= {AMEBAD2_REG_AON_ROR,		POR_SYSON},
	[RTK_POR_AON_OTP]			= {AMEBAD2_REG_AON_ROR,		POR_AON_OTP},
	[RTK_POR_LP_PLAT]			= {AMEBAD2_REG_LSYS_POR,	POR_LP_PLAT},
	[RTK_POR_HP_PLAT]			= {AMEBAD2_REG_LSYS_POR,	POR_HP_PLAT},
	[RTK_POR_LP_BTON]			= {AMEBAD2_REG_LSYS_POR,	POR_LP_BTON},
	[RTK_POR_HP_DDRPHY]			= {AMEBAD2_REG_LSYS_POR,	POR_HP_DDRPHY},
};
#endif

static const struct rtk_rcc_data amebad2_rcc_data = {
	.clocks = amebad2_clk_data,
	.clock_num = RTK_CLK_MAX_NUM,
#ifdef CONFIG_RESET_CONTROLLER
	.resets = amebad2_reset_map,
	.reset_num = RTK_RST_MAX_NUM
#endif
};

static const struct of_device_id amebad2_of_match[] = {
	{
		.compatible = "realtek,amebad2-rcc",
		.data = &amebad2_rcc_data
	},
	{}
};
...
static int rtk_gate_clk_enable(struct clk_hw *hw)
{
	...
	spin_lock_irqsave(&amebad2_clk_lock, flags);
	...
	spin_unlock_irqrestore(&amebad2_clk_lock, flags);
...
static int rtk_reset_assert(struct reset_controller_dev *rdev, unsigned long id)
{
	...
	if (map != NULL) {
		...
		spin_lock_irqsave(&amebad2_reset_lock, flags);

		val = readw(reg);
		writew(val & ~map->bit, reg);

		spin_unlock_irqrestore(&amebad2_reset_lock, flags);
	}
...
static struct clk_hw *rtk_clk_lookup_index(int index)
{
	...
	if (index < amebad2_rcc_data.clock_num) {
		clk = (struct rtk_clk *)amebad2_clk_data[index];
		if (clk) {
			if ((clk->flags & RTK_CLK_MASK) == RTK_CLK_GATE) {
				hw = &clk->gate.hw;
			} else if ((clk->flags & RTK_CLK_MASK) == RTK_CLK_MUX) {
...
static void __init rtk_rcc_init(struct device_node *node)
{
	...
	match = of_match_node(amebad2_of_match, node);
	if (WARN_ON(!match)) {
		return;
	}
	...
	reset->rdev.nr_resets = amebad2_rcc_data.reset_num;
	reset->map = amebad2_rcc_data.resets;
...
CLK_OF_DECLARE_DRIVER(amebad2_rcc, "realtek,amebad2-rcc", rtk_rcc_init);
