...
static const u8 wl_rssi_step_8730a[] = {60, 50, 44, 30};
static const u8 bt_rssi_step_8730a[] = {8, 15, 20, 25};

/* Shared-Antenna Coex Table */
static const struct btc_coex_table_para table_sant_8730a[] = {
...
static const struct btc_coex_table_para table_nsant_8730a[] = {
...
/* Shared-Antenna TDMA*/
static const struct btc_tdma_para tdma_sant_8730a[] = {
...
static const struct btc_tdma_para tdma_nsant_8730a[] = {
...
static const struct btc_rf_para rf_para_tx_8730a[] = {
...
static const struct btc_rf_para rf_para_rx_8730a[] = {
	{0, 0, FALSE, 7},  /* for normal */
	{0, 16, FALSE, 7}, /* for WL-CPT */
	{0, 8, TRUE, 7},  /* 2 for RCU SDR*/
	{0, 8, TRUE, 7},
...
const struct btc_5g_afh_map afh_5g_8730a[] = { {0, 0, 0} };
...
extern const struct btc_chip_para btc_chip_para_8730a = {
	...
	2,					/*.rssi_tolerance */
	2,					/* rx_path_num */
	ARRAY_SIZE(wl_rssi_step_8730a),		/*.wl_rssi_step_num */
	wl_rssi_step_8730a,			/*.wl_rssi_step */
	ARRAY_SIZE(bt_rssi_step_8730a),		/*.bt_rssi_step_num */
	bt_rssi_step_8730a,			/*.bt_rssi_step */
	ARRAY_SIZE(table_sant_8730a),		/*.table_sant_num */
	table_sant_8730a,			/*.table_sant = */
	ARRAY_SIZE(table_nsant_8730a),		/*.table_nsant_num */
	table_nsant_8730a,			/*.table_nsant = */
	ARRAY_SIZE(tdma_sant_8730a),		/*.tdma_sant_num */
	tdma_sant_8730a,			/*.tdma_sant = */
	ARRAY_SIZE(tdma_nsant_8730a),		/*.tdma_nsant_num */
	tdma_nsant_8730a,			/*.tdma_nsant */
	ARRAY_SIZE(rf_para_tx_8730a),		/* wl_rf_para_tx_num */
	rf_para_tx_8730a,		        /* wl_rf_para_tx */
	rf_para_rx_8730a,		        /* wl_rf_para_rx */
	0x24,					/*.bt_afh_span_bw20 */
	0x36,					/*.bt_afh_span_bw40 */
	ARRAY_SIZE(afh_5g_8730a),		/*.afh_5g_num */
	afh_5g_8730a,				/*.afh_5g */
	halbtc8730a_chip_setup			/* chip_setup function */
};
...
void halbtc8730a_cfg_gnt_fix(struct btc_coexist *btc)
{
}
...
void halbtc8730a_cfg_rfe_type(struct btc_coexist *btc)
{
...
void halbtc8730a_chip_setup(struct btc_coexist *btc, u8 type)
{
	...
	case BTC_CSETUP_INIT_HW:
		halbtc8730a_cfg_init(btc);
		break;
	case BTC_CSETUP_ANT_SWITCH:
		halbtc8730a_cfg_ant_switch(btc);
		break;
	case BTC_CSETUP_GNT_FIX:
		halbtc8730a_cfg_gnt_fix(btc);
		break;
	case BTC_CSETUP_GNT_DEBUG:
		halbtc8730a_cfg_gnt_debug(btc);
		break;
	case BTC_CSETUP_RFE_TYPE:
		halbtc8730a_cfg_rfe_type(btc);
		break;
	case BTC_CSETUP_COEXINFO_HW:
		halbtc8730a_cfg_coexinfo_hw(btc);
		break;
	case BTC_CSETUP_WL_TX_POWER:
		halbtc8730a_cfg_wl_tx_power(btc);
		break;
	case BTC_CSETUP_WL_RX_GAIN:
		halbtc8730a_cfg_wl_rx_gain(btc);
		break;
	case BTC_CSETUP_WLAN_ACT_IPS:
		halbtc8730a_cfg_wlan_act_ips(btc);
		break;
	case BTC_CSETUP_BT_CTRL_ACT:
		halbtc8730a_cfg_bt_ctrl_act(btc);
		break;
	}
}
#endif
