...
void hal_btcoex_wifionly_switchband_notify(PADAPTER padapter)
{
	...
	if (IS_HARDWARE_TYPE_8822B(padapter)) {
		...
		ex_hal8730a_wifi_only_switchbandnotify(&GLBtCoexistWifiOnly, is_5g);
	}
#endif
}
...
void hal_btcoex_wifionly_connect_notify(PADAPTER padapter)
{
	...
	if (IS_HARDWARE_TYPE_8822B(padapter)) {
		...
		ex_hal8730a_wifi_only_connectnotify(&GLBtCoexistWifiOnly, is_5g);
	}
#endif
}
...
void hal_btcoex_wifionly_hw_config(PADAPTER padapter)
{
	...
	if (IS_HARDWARE_TYPE_8723B(padapter)) {
		...
		ex_hal8730a_wifi_only_hw_config(pwifionlycfg);
	}
#endif
}
...
void hal_btcoex_wifionly_initlizevariables(PADAPTER padapter)
{
	...
	pwifionlycfg->chip_interface = WIFIONLY_INTF_AXI;
