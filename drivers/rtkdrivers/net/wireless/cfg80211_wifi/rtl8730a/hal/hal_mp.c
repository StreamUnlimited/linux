...
)
{
	...
	if (IS_HARDWARE_TYPE_8814A(pAdapter) || IS_HARDWARE_TYPE_8814B(pAdapter)) {
		...
		tx_nss = 4;
		   ...
		   || IS_HARDWARE_TYPE_8723D(pAdapter) || IS_HARDWARE_TYPE_8821C(pAdapter) || IS_HARDWARE_TYPE_8730A(pAdapter)) {
		EndPath = RF_PATH_A;
		tx_nss = 1;
	}
...
void mpt_SetRFPath_8814A(PADAPTER	pAdapter)
{
	...
	|| defined(CONFIG_RTL8822C) || defined(CONFIG_RTL8814B) || defined(CONFIG_RTL8730A)
void
...
void hal_mpt_SetAntenna(PADAPTER	pAdapter)
{
	...
	if (IS_HARDWARE_TYPE_8730A(pAdapter)) {
		rtl8730a_mp_config_rfpath(pAdapter);
		return;
	}
#endif
...

{
	...
	if (IS_8730A_SERIES(GET_HAL_DATA(pAdapter)->version_id)) {
...
void hal_mpt_SetSingleCarrierTx(PADAPTER pAdapter, u8 bStart)
{
	...
	|| defined(CONFIG_RTL8822B) || defined(CONFIG_RTL8821C) || defined(CONFIG_RTL8730A)
	...
	|| defined(CONFIG_RTL8821C) || defined(CONFIG_RTL8730A)
		if (IS_HARDWARE_TYPE_JAGUAR_ALL(pAdapter) || IS_HARDWARE_TYPE_JAGUAR3_11N(pAdapter)) {
