...
download_flash_87xx(struct halmac_adapter *adapter, u8 *fw_bin, u32 size,
	...
	value8 = HALMAC_REG_R8(REG_BCN_CTRL_PORT0);
	restore[1] = value8;
	value8 = (u8)((value8 & ~(BIT(3))) | BIT(4));
	HALMAC_REG_W8(REG_BCN_CTRL_PORT0, value8);
	...
	HALMAC_REG_W8(REG_FWHW_TXQ_HWSSN_CTRL + 2, restore[2]);
	HALMAC_REG_W8(REG_BCN_CTRL_PORT0, restore[1]);
