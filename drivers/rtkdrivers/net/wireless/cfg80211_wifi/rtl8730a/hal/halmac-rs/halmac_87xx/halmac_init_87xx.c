...
#include "halmac_8730a/halmac_init_8730a.h"
#endif
...
mount_api_87xx(struct halmac_adapter *adapter) {
	...
	api->halmac_read_efuse = read_efuse_87xx;
	api->halmac_write_efuse = write_efuse_87xx;
	...
	api->halmac_write_logical_efuse_8730A = write_log_efuse_8730A; //jerry_zhou
	...
	{
#if HALMAC_AXI_SUPPORT
		api->halmac_cfg_rx_aggregation = cfg_axi_rx_agg_87xx;
		api->halmac_init_interface_cfg = init_axi_cfg_87xx;
		api->halmac_deinit_interface_cfg = deinit_axi_cfg_87xx;
		api->halmac_cfg_tx_agg_align = cfg_txagg_axi_align_87xx;
		api->halmac_tx_allowed_sdio = tx_allowed_axi_87xx;
		api->halmac_set_bulkout_num = set_axi_bulkout_num_87xx;
		api->halmac_get_sdio_tx_addr = get_axi_tx_addr_87xx;
		api->halmac_get_usb_bulkout_id = get_axi_bulkout_id_87xx;
		api->halmac_reg_read_8 = reg_r8_axi_87xx;
		api->halmac_reg_write_8 = reg_w8_axi_87xx;
		api->halmac_reg_read_16 = reg_r16_axi_87xx;
		api->halmac_reg_write_16 = reg_w16_axi_87xx;
		api->halmac_reg_read_32 = reg_r32_axi_87xx;
		api->halmac_reg_write_32 = reg_w32_axi_87xx;
		api->halmac_sys_reg_read_8 = sys_reg_r8_axi_87xx;
		api->halmac_sys_reg_write_8 = sys_reg_w8_axi_87xx;
		api->halmac_sys_reg_read_16 = sys_reg_r16_axi_87xx;
		api->halmac_sys_reg_write_16 = sys_reg_w16_axi_87xx;
		api->halmac_sys_reg_read_32 = sys_reg_r32_axi_87xx;
		api->halmac_sys_reg_write_32 = sys_reg_w32_axi_87xx;
		api->halmac_reg_read_indirect_32 = axi_indirect_reg_r32_87xx;
		api->halmac_reg_sdio_cmd53_read_n = axi_reg_rn_87xx;
#endif
	} else
	{
	...
	if (adapter->chip_id == HALMAC_CHIP_ID_8730A)
	{
#if HALMAC_8730A_SUPPORT
		mount_api_8730a(adapter);
#endif
