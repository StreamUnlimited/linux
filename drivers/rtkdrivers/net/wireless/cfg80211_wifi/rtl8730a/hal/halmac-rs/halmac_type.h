...
#define PLTFM_SYS_REG_R8(base, offset)                                                   \
	adapter->pltfm_api->SYS_REG_READ_8(adapter->drv_adapter, base, offset)
#define PLTFM_SYS_REG_R16(base, offset)                                                  \
	adapter->pltfm_api->SYS_REG_READ_16(adapter->drv_adapter, base, offset)
#define PLTFM_SYS_REG_R32(base, offset)                                                  \
	adapter->pltfm_api->SYS_REG_READ_32(adapter->drv_adapter, base, offset)
#define PLTFM_SYS_REG_W8(base, offset, val)                                              \
	adapter->pltfm_api->SYS_REG_WRITE_8(adapter->drv_adapter, base, offset, val)
#define PLTFM_SYS_REG_W16(base, offset, val)                                             \
	adapter->pltfm_api->SYS_REG_WRITE_16(adapter->drv_adapter, base, offset, val)
#define PLTFM_SYS_REG_W32(base, offset, val)                                             \
	adapter->pltfm_api->SYS_REG_WRITE_32(adapter->drv_adapter, base, offset, val)
...
#define HALMAC_SYS_REG_R8(base, offset) api->halmac_sys_reg_read_8(adapter, base, offset)
#define HALMAC_SYS_REG_R16(base, offset) api->halmac_sys_reg_read_16(adapter, base, offset)
#define HALMAC_SYS_REG_R32(base, offset) api->halmac_sys_reg_read_32(adapter, base, offset)
#define HALMAC_SYS_REG_W8(base, offset, val) api->halmac_sys_reg_write_8(adapter, base, offset, val)
#define HALMAC_SYS_REG_W16(base, offset, val)                                            \
	api->halmac_sys_reg_write_16(adapter, base, offset, val)
#define HALMAC_SYS_REG_W32(base, offset, val)                                            \
	api->halmac_sys_reg_write_32(adapter, base, offset, val)
...
struct halmac_platform_api {
	...
	u8(*SYS_REG_READ_8)(void *drv_adapter, u32 base, u32 offset);
	u16(*SYS_REG_READ_16)(void *drv_adapter, u32 base, u32 offset);
	u32(*SYS_REG_READ_32)(void *drv_adapter, u32 base, u32 offset);
	void (*SYS_REG_WRITE_8)(void *drv_adapter, u32 base, u32 offset, u8 value);
	void (*SYS_REG_WRITE_16)(void *drv_adapter, u32 base, u32 offset, u16 value);
	void (*SYS_REG_WRITE_32)(void *drv_adapter, u32 base, u32 offset, u32 value);
...
struct halmac_api {
	...
	//jerry_zhou
	enum halmac_ret_status
	(*halmac_write_logical_efuse_8730A)(struct halmac_adapter *adapter,
	...
	(*halmac_reg_write_32)(struct halmac_adapter *adapter, u32 offset,
			       u32 value);
	u8
	(*halmac_sys_reg_read_8)(struct halmac_adapter *adapter, u32 base, u32 offset);
	enum halmac_ret_status
	(*halmac_sys_reg_write_8)(struct halmac_adapter *adapter, u32 base, u32 offset,
				  u8 value);
	u16
	(*halmac_sys_reg_read_16)(struct halmac_adapter *adapter, u32 base, u32 offset);
	enum halmac_ret_status
	(*halmac_sys_reg_write_16)(struct halmac_adapter *adapter, u32 base, u32 offset,
				   u16 value);
	u32
	(*halmac_sys_reg_read_32)(struct halmac_adapter *adapter, u32 base, u32 offset);
	enum halmac_ret_status
	(*halmac_sys_reg_write_32)(struct halmac_adapter *adapter, u32 base, u32 offset,
				   u32 value);
	u32
