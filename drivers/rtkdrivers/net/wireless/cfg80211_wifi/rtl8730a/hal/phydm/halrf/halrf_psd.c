...
#endif
#if (DM_ODM_SUPPORT_TYPE & (ODM_IOT | ODM_CE))
	...
	u32 average)
{
	...
	if (mode == 2) {
		if (dm->support_ic_type & (ODM_RTL8822C | ODM_RTL8723F | ODM_RTL8814C | ODM_RTL8735B | ODM_RTL8730A)) {
...
halrf_psd_init(void *dm_void)
{
	...
	RTL8198F_SUPPORT == 1 || RTL8197G_SUPPORT == 1)
		...
		if (!(dm->support_ic_type &
		      (ODM_RTL8822C | ODM_RTL8812F | ODM_RTL8814B | ODM_RTL8198F | ODM_RTL8197G |
		       ODM_RTL8735B | ODM_RTL8730A | ODM_RTL8814C | ODM_RTL8723F))) {
