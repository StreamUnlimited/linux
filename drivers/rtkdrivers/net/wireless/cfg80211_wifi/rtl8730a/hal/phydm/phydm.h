...
struct _phydm_mcc_dm_ {
	...
	u16		mcc_rf_ch[2];
	 ...
	 RTL8735B_SUPPORT || RTL8730A_SUPPORT || RTL8814B_SUPPORT)
struct phydm_physts {
	u8			cck_gi_u_bnd;
	u8			cck_gi_l_bnd;
};
...
struct dm_struct {
...
#if (RTL8822C_SUPPORT || RTL8814B_SUPPORT || RTL8197G_SUPPORT || RTL8730A_SUPPORT)
	...
	u32			bp_0x9b0;
#endif
#if (RTL8822C_SUPPORT || RTL8723F_SUPPORT || RTL8735B_SUPPORT || RTL8730A_SUPPORT)
