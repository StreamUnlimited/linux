...
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	PADAPTER padapter = (PADAPTER)dm->adapter;
	struct phydm_cfo_track_struct *cfo_track = &dm->dm_cfo_track;
	u32 reg_val = 0, value32 = 0;
	...
	if (dm->support_ic_type & (ODM_RTL8188E | ODM_RTL8188F)) {
		...
		value32 = rtw_sys_read32(padapter, SYSTEM_CTRL_BASE_LP, XTAL_ANAPAR_XTAL_ON_0);
		value32 &= (~ 0x00FFFC00);
		rtw_sys_write32(padapter, SYSTEM_CTRL_BASE_LP, XTAL_ANAPAR_XTAL_ON_0, value32);
		value32 = rtw_sys_read32(padapter, SYSTEM_CTRL_BASE_LP, XTAL_ANAPAR_XTAL_ON_0);
		value32 |= (reg_val << 10);
		rtw_sys_write32(padapter, SYSTEM_CTRL_BASE_LP, XTAL_ANAPAR_XTAL_ON_0, value32);
	}
