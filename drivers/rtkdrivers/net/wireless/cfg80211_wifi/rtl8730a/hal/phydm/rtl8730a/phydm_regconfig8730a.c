...
void odm_config_rf_radio_a_8730a(struct dm_struct *dm, u32 addr, u32 data)
{
	...
	odm_config_rf_reg_8730a(dm, addr, data, RF_PATH_A, addr |
				maskfor_phy_set);
...
void odm_config_rf_radio_b_8730a(struct dm_struct *dm, u32 addr, u32 data)
{
	...
	odm_config_rf_reg_8730a(dm, addr, data, RF_PATH_B, addr |
				maskfor_phy_set);
...
void odm_config_bb_agc_8730a(struct dm_struct *dm, u32 addr, u32 bitmask,
			     u32 data)
{
	/* odm_update_agc_big_jump_lmt_8730a(dm, addr, data); */
...
void odm_config_bb_txpwr_lmt_8730a(struct dm_struct *dm, u8 *regulation,
