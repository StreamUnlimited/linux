...
)
{
	...
	tmp_reg422 = platform_efio_read_1byte(adapter, REG_FWHW_TXQ_HWSSN_CTRL_8814A + 2);
	platform_efio_write_1byte(adapter, REG_FWHW_TXQ_HWSSN_CTRL_8814A + 2,  tmp_reg422 & (~BIT(6)));
	...
	if (is_send_beacon) {
		platform_efio_write_1byte(adapter, REG_FWHW_TXQ_HWSSN_CTRL_8814A + 2, tmp_reg422);
	}
