 ...
 */
static void SwLedOn_8814be(PADAPTER adapter, PLED_PCIE pLed)
{
#if 0
 ...
 */
static void SwLedOff_8814be(PADAPTER adapter, PLED_PCIE pLed)
{
#if 0
	u16 LedReg = REG_LEDCFG0;
 ...
 */
void rtl8730aa_InitSwLeds(PADAPTER adapter)
{
	struct led_priv *pledpriv = adapter_to_led(adapter);

	pledpriv->LedControlHandler = LedControlPCIE;

	pledpriv->SwLedOn = SwLedOn_8814be;
	pledpriv->SwLedOff = SwLedOff_8814be;
 ...
 */
void rtl8730aa_DeInitSwLeds(PADAPTER adapter)
{
	struct led_priv	*ledpriv = adapter_to_led(adapter);
