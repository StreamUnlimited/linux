...
int PHY_BBConfig8730A(PADAPTER	Adapter);

int PHY_RFConfig8730A(PADAPTER	Adapter);

s32 PHY_MACConfig8730A(PADAPTER padapter);

int
PHY_ConfigRFWithParaFile_8730A(
	PADAPTER			Adapter,
	u8				*pFileName,
	enum rf_path				eRFPath
);
...
void phy_set_rf_path_switch_8730a(
