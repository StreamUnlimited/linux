...
/* feature deponded on NL80211_SCAN_FLAG_RANDOM_ADDR to set random
 * MAC address for probe request.
 */
/*#ifndef CONFIG_RTW_SCAN_RAND
#define CONFIG_RTW_SCAN_RAND
#endif*/
...
#define CONFIG_RTW_COUNTRY_IE_SLAVE_EN_IFBMP 0xFF /* all iface */
		...
		|| defined(CONFIG_RTL8814A) || defined(CONFIG_RTL8814B) || defined(CONFIG_RTL8730A)
...
#define CONFIG_TXPWR_BY_RATE_EN 1 /* by efuse */
#endif
...
defined(CONFIG_RTL8730A) /*|| defined(CONFIG_RTL8814A)*/
