...
struct hal_ops {
...
#endif
#if defined(CONFIG_USB_HCI) || defined(CONFIG_PCI_HCI) || defined(CONFIG_AXI_HCI)
	...
	s32(*fw_en)(_adapter *adapter, u8 enable);
#ifdef RTW_HALMAC
	s32(*fw_mem_dl)(_adapter *adapter, enum fw_mem mem);
#endif

#if defined(CONFIG_WOWLAN) || defined(CONFIG_AP_WOWLAN) || defined(CONFIG_PCI_HCI) || defined(CONFIG_AXI_HCI)
...
/* RTL8730A Series */
#define IS_HARDWARE_TYPE_8730AA(_Adapter)\
	(rtw_get_hw_type(_Adapter) == HARDWARE_TYPE_RTL8730AA)
#define	IS_HARDWARE_TYPE_8730A(_Adapter)\
	(IS_HARDWARE_TYPE_8730AA(_Adapter))
...
#define IS_HARDWARE_TYPE_JAGUAR3_11N(_Adapter)	(IS_HARDWARE_TYPE_8723F(_Adapter) || IS_HARDWARE_TYPE_8730AA(_Adapter))
...
#endif
s32 rtw_hal_fw_en(_adapter *padapter, u8 enable);
