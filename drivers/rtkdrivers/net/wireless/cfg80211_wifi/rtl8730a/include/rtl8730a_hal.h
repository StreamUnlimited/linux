 ...
 *
 *****************************************************************************/
#ifndef _RTL8730A_HAL_H_
#define _RTL8730A_HAL_H_

#include <osdep_service.h>		/* BIT(x) */
#include <drv_types.h>			/* PADAPTER */
#include "../hal/halmac-rs/halmac_api.h"	/* MAC REG definition */

#define MAX_RX_PKT_SIZE (1578)
#define MAX_RX_PKT_LIMIT (4)
#define RX_DRIVER_INFO (32)
#define SKB_RESERVED_FOR_SAFETY 8
#define HAL_INTERFACE_OVERHEAD_SKB_DATA 0

/*
 * MAC Register definition
 */
#define REG_LEDCFG0		REG_LED_CFG_8730A	/* rtw_mp.c */
#define MSR			(REG_CR_8730A + 2)	/* rtw_mp.c & hal_com.c */
#define REG_C2HEVT_MSG_NORMAL	0x1A0			/* hal_com.c */
#define REG_C2HEVT_CLEAR	0x1AF			/* hal_com.c */
#define REG_BCN_CTRL_1		REG_BCN_CTRL_CLINT0_8730A	/* hal_com.c */

#define REG_WOWLAN_WAKE_REASON	0x01C7 /* hal_com.c */
#define REG_GPIO_PIN_CTRL_2 		REG_GPIO_EXT_CTRL_8730A	/* hal_com.c */
#define REG_FIFOPAGE 				REG_FIFOPAGE_INFO_8730A /* hal_com.c */
#define REG_RXPKTBUF_CTRL 			REG_PKTBUF_DBG_CTRL_8730A /* hal_com.c */
#define REG_WKFMCAM_NUM 			REG_WKFMCAM_CMD_8730A /* hal_com.c */
#define REG_CAMCMD					REG_KEYCAMCMD_8730A /* hal_com.c */
#define REG_CAMWRITE				REG_KEYCAM_WD_8730A /* hal_com.c */

#define BIT_AUTO_SYNC_BY_TBTT 		BIT_EN_TSFAUTO_SYNC_8730A /* hal_com.c */
#define BIT_SECCAM_POLLING_8730A	BIT_KEYCAM_POLLING_8730A /* rtl8730a_ops.c */
...
#define RXERR_COUNTER_MASK		BIT_MASK_RPT_COUNTER_8730A
#define RXERR_RPT_RST			BIT_RXERR_RPT_RST_8730A
#define _RXERR_RPT_SEL(type)		(BIT_RXERR_RPT_SEL_V1_3_0_8730A(type) \
					| ((type & 0x10) ? BIT_RXERR_RPT_SEL_V1_4_8730A : 0))
...
#define rHSSIRead_Jaguar		0x8B0	/* RF read addr (rtl8730a_phy.c) */
...
/* TX BeamForming */
#define REG_BB_TX_PATH_SEL_1_8730A	0x93C	/* rtl8730a_phy.c */
#define REG_BB_TX_PATH_SEL_2_8730A	0x940	/* rtl8730a_phy.c */

/* TX BeamForming */
#define REG_BB_TXBF_ANT_SET_BF1_8730A	0x19AC	/* rtl8730a_phy.c */
#define REG_BB_TXBF_ANT_SET_BF0_8730A	0x19B4	/* rtl8730a_phy.c */
...
#define rA_PIRead_Jaguar		0xD04	/* RF readback with PI (rtl8730a_phy.c) */
#define rA_SIRead_Jaguar		0xD08	/* RF readback with SI (rtl8730a_phy.c) */
#define rB_PIRead_Jaguar		0xD44	/* RF readback with PI (rtl8730a_phy.c) */
#define rB_SIRead_Jaguar		0xD48	/* RF readback with SI (rtl8730a_phy.c) */
...
#define RF_CHNLBW		0x18	/* rtl8730a_phy.c */
#define RF_ModeTableAddr	0x30	/* rtl8730a_phy.c */
#define RF_ModeTableData0	0x31	/* rtl8730a_phy.c */
#define RF_ModeTableData1	0x32	/* rtl8730a_phy.c */
#define RF_0x52			0x52
#define RF_WeLut_Jaguar		0xEF	/* rtl8730a_phy.c */

/* rtw_lps_state_chk() @hal_com.c */
#define BIT_PWRBIT_OW_EN	BIT_WMAC_TCR_PWRMGT_CTL_8730A

/*
* General Functions
*/
void rtl8730a_init_hal_spec(PADAPTER);				/* hal/hal_com.c */

#ifdef CONFIG_MP_INCLUDED
/* MP Functions */
#include <rtw_mp.h>		/* struct mp_priv */
void rtl8730a_prepare_mp_txdesc(PADAPTER, struct mp_priv *);	/* rtw_mp.c */
void rtl8730a_mp_config_rfpath(PADAPTER);			/* hal_mp.c */
#endif
...
#include <rtl8730au_hal.h>
#elif defined(CONFIG_SDIO_HCI)
#include <rtl8730as_hal.h>
#endif

#endif /* _RTL8730A_HAL_H_ */
