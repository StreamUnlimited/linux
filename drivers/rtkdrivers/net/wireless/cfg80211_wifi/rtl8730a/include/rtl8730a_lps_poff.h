...
/*********************Function Definition*******************************************/
void rtl8730a_lps_poff_init(PADAPTER padapter);
void rtl8730a_lps_poff_deinit(PADAPTER padapter);
bool rtl8730a_lps_poff_get_txbndy_status(PADAPTER padapter);
void rtl8730a_lps_poff_h2c_ctrl(PADAPTER padapter, u8 enable);
void rtl8730a_lps_poff_set_ps_mode(PADAPTER padapter, bool bEnterLPS);
bool rtl8730a_lps_poff_get_status(PADAPTER padapter);
void rtl8730a_lps_poff_wow(PADAPTER padapter);
