...
struct _io_ops {
	...
	u8(*_sys_read8)(struct intf_hdl *pintfhdl, u32 base, u32 addr);
	u16(*_sys_read16)(struct intf_hdl *pintfhdl, u32 base, u32 addr);
	u32(*_sys_read32)(struct intf_hdl *pintfhdl, u32 base, u32 addr);

	int (*_sys_write8)(struct intf_hdl *pintfhdl, u32 base, u32 addr, u8 val);
	int (*_sys_write16)(struct intf_hdl *pintfhdl, u32 base, u32 addr, u16 val);
	int (*_sys_write32)(struct intf_hdl *pintfhdl, u32 base, u32 addr, u32 val);
...
#ifdef CONFIG_AXI_HCI
extern u8 _rtw_sys_read8(_adapter *adapter, u32 base, u32 addr);
extern u16 _rtw_sys_read16(_adapter *adapter, u32 base, u32 addr);
extern u32 _rtw_sys_read32(_adapter *adapter, u32 base, u32 addr);

extern int _rtw_sys_write8(_adapter *adapter, u32 base, u32 addr, u8 val);
extern int _rtw_sys_write16(_adapter *adapter, u32 base, u32 addr, u16 val);
extern int _rtw_sys_write32(_adapter *adapter, u32 base, u32 addr, u32 val);
#endif
...
#ifdef CONFIG_AXI_HCI
#define rtw_sys_read8(adapter, base, addr) _rtw_sys_read8((adapter), (base), (addr))
#define rtw_sys_read16(adapter, base, addr) _rtw_sys_read16((adapter), (base), (addr))
#define rtw_sys_read32(adapter, base, addr) _rtw_sys_read32((adapter), (base), (addr))

#define rtw_sys_write8(adapter, base, addr, val) _rtw_sys_write8((adapter), (base), (addr), (val))
#define rtw_sys_write16(adapter, base, addr, val) _rtw_sys_write16((adapter), (base), (addr), (val))
#define rtw_sys_write32(adapter, base, addr, val) _rtw_sys_write32((adapter), (base), (addr), (val))
#endif
