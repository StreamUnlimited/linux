...
#elif defined (CONFIG_PCI_HCI) || defined (CONFIG_AXI_HCI)
...
#if defined (CONFIG_PCI_HCI) || defined (CONFIG_AXI_HCI)
#if defined(CONFIG_RTL8192E) || defined(CONFIG_RTL8814A) || defined(CONFIG_RTL8730A)|| defined(CONFIG_RTL8822B) || defined(CONFIG_RTL8821C) || defined(CONFIG_RTL8822C) || defined(CONFIG_TRX_BD_ARCH)
...
#define TXDESC_64_BYTES
	...
	|| defined(CONFIG_RTL8188F) || defined(CONFIG_RTL8188GTV) || defined(CONFIG_RTL8730A) \
	|| defined(CONFIG_RTL8192F) || defined(CONFIG_RTL8730A)
...
#define AXI_MAX_TX_QUEUE_COUNT	HW_QUEUE_ENTRY
...
#if defined (CONFIG_PCI_HCI) || defined (CONFIG_AXI_HCI)
	/* Tx */
	struct rtw_tx_ring	tx_ring[AXI_MAX_TX_QUEUE_COUNT];
...
#elif defined(CONFIG_RTL8730A) && defined(CONFIG_AXI_HCI)
extern struct xmit_frame *__rtw_alloc_cmdxmitframe_8730aa(struct xmit_priv *pxmitpriv,
		enum cmdbuf_type buf_type);
#define rtw_alloc_bcnxmitframe(p) __rtw_alloc_cmdxmitframe_8730aa(p, CMDBUF_BEACON)
