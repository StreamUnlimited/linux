...
#ifdef defined(CONFIG_TDLS) && defined(CONFIG_P2P)
...
#ifdef CONFIG_RTL8730A
#include <../../hal/rtl8730a/rtl8730a.h>

#define REG_LOOPBACK_ENABLE 0x0103
#define LOOKBACK_ENABLE_VALUE 0x0b
#define cal_txdesc_chksum(padapter, desc) rtl8730a_cal_txdesc_chksum(padapter, desc)
#define dump_txdesc_data(padapter, desc) rtl8730a_dbg_dump_tx_desc(padapter, DATA_FRAMETAG, desc);
#define get_rx_desc(rx_desc, rxbuf) rtl8730a_rxdesc2attribute(rx_desc, rxbuf)
#define hal_init rtl8730a_hal_init
#endif /* CONFIG_RTL8730B */
