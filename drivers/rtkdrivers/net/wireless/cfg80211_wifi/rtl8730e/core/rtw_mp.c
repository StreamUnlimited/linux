...
static u16 srate2herate(u8 *str)
{
	...
	if (!strcmp(str, "1M")) {
		...
		return HRATE_CCK2;
	} else if (!strcmp(str, "5.5M")) {
		return HRATE_CCK5_5;
	} else if (!strcmp(str, "11M")) {
		return HRATE_CCK11;
		...
		return HRATE_OFDM12;
	} else if (!strcmp(str, "18M")) {
		return HRATE_OFDM18;
	} else if (!strcmp(str, "24M")) {
		return HRATE_OFDM24;
	} else if (!strcmp(str, "36M")) {
		return HRATE_OFDM36;
	} else if (!strcmp(str, "48M")) {
		return HRATE_OFDM48;
	} else if (!strcmp(str, "54M")) {
		return HRATE_OFDM54;
	} else if (!strcmp(str, "HTMCS0")) {
		return HRATE_MCS0;
	} else if (!strcmp(str, "HTMCS1")) {
		return HRATE_MCS1;
	} else if (!strcmp(str, "HTMCS2")) {
		return HRATE_MCS2;
	} else if (!strcmp(str, "HTMCS3")) {
		return HRATE_MCS3;
	} else if (!strcmp(str, "HTMCS4")) {
		return HRATE_MCS4;
	} else if (!strcmp(str, "HTMCS5")) {
		return HRATE_MCS5;
	} else if (!strcmp(str, "HTMCS6")) {
		return HRATE_MCS6;
	} else if (!strcmp(str, "HTMCS7")) {
		return HRATE_MCS7;
	} else if (!strcmp(str, "HTMCS8")) {
		return HRATE_MCS8;
	} else if (!strcmp(str, "HTMCS9")) {
		return HRATE_MCS9;
	} else if (!strcmp(str, "HTMCS10")) {
		return HRATE_MCS10;
	} else if (!strcmp(str, "HTMCS11")) {
		return HRATE_MCS11;
	} else if (!strcmp(str, "HTMCS12")) {
		return HRATE_MCS12;
	} else if (!strcmp(str, "HTMCS13")) {
		return HRATE_MCS13;
	} else if (!strcmp(str, "HTMCS14")) {
		return HRATE_MCS14;
	} else if (!strcmp(str, "HTMCS15")) {
		return HRATE_MCS15;
	} else if (!strcmp(str, "HTMCS16")) {
		return HRATE_MCS16;
	} else if (!strcmp(str, "HTMCS17")) {
		return HRATE_MCS17;
	} else if (!strcmp(str, "HTMCS18")) {
		return HRATE_MCS18;
	} else if (!strcmp(str, "HTMCS19")) {
		return HRATE_MCS19;
	} else if (!strcmp(str, "HTMCS20")) {
		return HRATE_MCS20;
	} else if (!strcmp(str, "HTMCS21")) {
		return HRATE_MCS21;
	} else if (!strcmp(str, "HTMCS22")) {
		return HRATE_MCS22;
	} else if (!strcmp(str, "HTMCS23")) {
		return HRATE_MCS23;
	} else if (!strcmp(str, "HTMCS24")) {
		return HRATE_MCS24;
	} else if (!strcmp(str, "HTMCS25")) {
		return HRATE_MCS25;
	} else if (!strcmp(str, "HTMCS26")) {
		return HRATE_MCS26;
	} else if (!strcmp(str, "HTMCS27")) {
		return HRATE_MCS27;
	} else if (!strcmp(str, "HTMCS28")) {
		return HRATE_MCS28;
	} else if (!strcmp(str, "HTMCS29")) {
		return HRATE_MCS29;
	} else if (!strcmp(str, "HTMCS30")) {
		return HRATE_MCS30;
	} else if (!strcmp(str, "HTMCS31")) {
		return HRATE_MCS31;
	} else if (!strcmp(str, "VHT1MCS0")) {
		return HRATE_VHT_NSS1_MCS0;
	} else if (!strcmp(str, "VHT1MCS1")) {
		return HRATE_VHT_NSS1_MCS1;
	} else if (!strcmp(str, "VHT1MCS2")) {
		return HRATE_VHT_NSS1_MCS2;
	} else if (!strcmp(str, "VHT1MCS3")) {
		return HRATE_VHT_NSS1_MCS3;
	} else if (!strcmp(str, "VHT1MCS4")) {
		return HRATE_VHT_NSS1_MCS4;
	} else if (!strcmp(str, "VHT1MCS5")) {
		return HRATE_VHT_NSS1_MCS5;
	} else if (!strcmp(str, "VHT1MCS6")) {
		return HRATE_VHT_NSS1_MCS6;
	} else if (!strcmp(str, "VHT1MCS7")) {
		return HRATE_VHT_NSS1_MCS7;
	} else if (!strcmp(str, "VHT1MCS8")) {
		return HRATE_VHT_NSS1_MCS8;
	} else if (!strcmp(str, "VHT1MCS9")) {
		return HRATE_VHT_NSS1_MCS9;
	} else if (!strcmp(str, "VHT2MCS0")) {
		return HRATE_VHT_NSS2_MCS0;
	} else if (!strcmp(str, "VHT2MCS1")) {
		return HRATE_VHT_NSS2_MCS1;
	} else if (!strcmp(str, "VHT2MCS2")) {
		return HRATE_VHT_NSS2_MCS2;
	} else if (!strcmp(str, "VHT2MCS3")) {
		return HRATE_VHT_NSS2_MCS3;
	} else if (!strcmp(str, "VHT2MCS4")) {
		return HRATE_VHT_NSS2_MCS4;
	} else if (!strcmp(str, "VHT2MCS5")) {
		return HRATE_VHT_NSS2_MCS5;
	} else if (!strcmp(str, "VHT2MCS6")) {
		return HRATE_VHT_NSS2_MCS6;
	} else if (!strcmp(str, "VHT2MCS7")) {
		return HRATE_VHT_NSS2_MCS7;
	} else if (!strcmp(str, "VHT2MCS8")) {
		return HRATE_VHT_NSS2_MCS8;
	} else if (!strcmp(str, "VHT2MCS9")) {
		return HRATE_VHT_NSS2_MCS9;
	} else if (!strcmp(str, "VHT3MCS0")) {
		return HRATE_VHT_NSS3_MCS0;
	} else if (!strcmp(str, "VHT3MCS1")) {
		return HRATE_VHT_NSS3_MCS1;
	} else if (!strcmp(str, "VHT3MCS2")) {
		return HRATE_VHT_NSS3_MCS2;
	} else if (!strcmp(str, "VHT3MCS3")) {
		return HRATE_VHT_NSS3_MCS3;
	} else if (!strcmp(str, "VHT3MCS4")) {
		return HRATE_VHT_NSS3_MCS4;
	} else if (!strcmp(str, "VHT3MCS5")) {
		return HRATE_VHT_NSS3_MCS5;
	} else if (!strcmp(str, "VHT3MCS6")) {
		return HRATE_VHT_NSS3_MCS6;
	} else if (!strcmp(str, "VHT3MCS7")) {
		return HRATE_VHT_NSS3_MCS7;
	} else if (!strcmp(str, "VHT3MCS8")) {
		return HRATE_VHT_NSS3_MCS8;
	} else if (!strcmp(str, "VHT3MCS9")) {
		return HRATE_VHT_NSS3_MCS9;
	} else if (!strcmp(str, "VHT4MCS0")) {
		return HRATE_VHT_NSS4_MCS0;
	} else if (!strcmp(str, "VHT4MCS1")) {
		return HRATE_VHT_NSS4_MCS1;
	} else if (!strcmp(str, "VHT4MCS2")) {
		return HRATE_VHT_NSS4_MCS2;
	} else if (!strcmp(str, "VHT4MCS3")) {
		return HRATE_VHT_NSS4_MCS3;
	} else if (!strcmp(str, "VHT4MCS4")) {
		return HRATE_VHT_NSS4_MCS4;
	} else if (!strcmp(str, "VHT4MCS5")) {
		return HRATE_VHT_NSS4_MCS5;
	} else if (!strcmp(str, "VHT4MCS6")) {
		return HRATE_VHT_NSS4_MCS6;
	} else if (!strcmp(str, "VHT4MCS7")) {
		return HRATE_VHT_NSS4_MCS7;
	} else if (!strcmp(str, "VHT4MCS8")) {
		return HRATE_VHT_NSS4_MCS8;
	} else if (!strcmp(str, "VHT4MCS9")) {
		return HRATE_VHT_NSS4_MCS9;
	} else if (!strcmp(str, "HE1MCS0")) {
		return HRATE_HE_NSS1_MCS0;
	} else if (!strcmp(str, "HE1MCS1")) {
		return HRATE_HE_NSS1_MCS1;
	} else if (!strcmp(str, "HE1MCS2")) {
		return HRATE_HE_NSS1_MCS2;
	} else if (!strcmp(str, "HE1MCS3")) {
		return HRATE_HE_NSS1_MCS3;
	} else if (!strcmp(str, "HE1MCS4")) {
		return HRATE_HE_NSS1_MCS4;
	} else if (!strcmp(str, "HE1MCS5")) {
		return HRATE_HE_NSS1_MCS5;
	} else if (!strcmp(str, "HE1MCS6")) {
		return HRATE_HE_NSS1_MCS6;
	} else if (!strcmp(str, "HE1MCS7")) {
		return HRATE_HE_NSS1_MCS7;
	} else if (!strcmp(str, "HE1MCS8")) {
		return HRATE_HE_NSS1_MCS8;
	} else if (!strcmp(str, "HE1MCS9")) {
		return HRATE_HE_NSS1_MCS9;
	} else if (!strcmp(str, "HE1MCS10")) {
		return HRATE_HE_NSS1_MCS10;
	} else if (!strcmp(str, "HE1MCS11")) {
		return HRATE_HE_NSS1_MCS11;
	} else if (!strcmp(str, "HE2MCS0")) {
		return HRATE_HE_NSS2_MCS0;
	} else if (!strcmp(str, "HE2MCS1")) {
		return HRATE_HE_NSS2_MCS1;
	} else if (!strcmp(str, "HE2MCS2")) {
		return HRATE_HE_NSS2_MCS2;
	} else if (!strcmp(str, "HE2MCS3")) {
		return HRATE_HE_NSS2_MCS3;
	} else if (!strcmp(str, "HE2MCS4")) {
		return HRATE_HE_NSS2_MCS4;
	} else if (!strcmp(str, "HE2MCS5")) {
		return HRATE_HE_NSS2_MCS5;
	} else if (!strcmp(str, "HE2MCS6")) {
		return HRATE_HE_NSS2_MCS6;
	} else if (!strcmp(str, "HE2MCS7")) {
		return HRATE_HE_NSS2_MCS7;
	} else if (!strcmp(str, "HE2MCS8")) {
		return HRATE_HE_NSS2_MCS8;
	} else if (!strcmp(str, "HE2MCS9")) {
		return HRATE_HE_NSS2_MCS9;
	} else if (!strcmp(str, "HE2MCS10")) {
		return HRATE_HE_NSS2_MCS10;
	} else if (!strcmp(str, "HE2MCS11")) {
		return HRATE_HE_NSS2_MCS11;
	} else if (!strcmp(str, "HE3MCS0")) {
		return HRATE_HE_NSS3_MCS0;
	} else if (!strcmp(str, "HE3MCS1")) {
		return HRATE_HE_NSS3_MCS1;
	} else if (!strcmp(str, "HE3MCS2")) {
		return HRATE_HE_NSS3_MCS2;
	} else if (!strcmp(str, "HE3MCS3")) {
		return HRATE_HE_NSS3_MCS3;
	} else if (!strcmp(str, "HE3MCS4")) {
		return HRATE_HE_NSS3_MCS4;
	} else if (!strcmp(str, "HE3MCS5")) {
		return HRATE_HE_NSS3_MCS5;
	} else if (!strcmp(str, "HE3MCS6")) {
		return HRATE_HE_NSS3_MCS6;
	} else if (!strcmp(str, "HE3MCS7")) {
		return HRATE_HE_NSS3_MCS7;
	} else if (!strcmp(str, "HE3MCS8")) {
		return HRATE_HE_NSS3_MCS8;
	} else if (!strcmp(str, "HE3MCS9")) {
		return HRATE_HE_NSS3_MCS9;
	} else if (!strcmp(str, "HE3MCS10")) {
		return HRATE_HE_NSS3_MCS10;
	} else if (!strcmp(str, "HE3MCS11")) {
		return HRATE_HE_NSS3_MCS11;
	} else if (!strcmp(str, "HE4MCS0")) {
		return HRATE_HE_NSS4_MCS0;
	} else if (!strcmp(str, "HE4MCS1")) {
		return HRATE_HE_NSS4_MCS1;
	} else if (!strcmp(str, "HE4MCS2")) {
		return HRATE_HE_NSS4_MCS2;
	} else if (!strcmp(str, "HE4MCS3")) {
		return HRATE_HE_NSS4_MCS3;
	} else if (!strcmp(str, "HE4MCS4")) {
		return HRATE_HE_NSS4_MCS4;
	} else if (!strcmp(str, "HE4MCS5")) {
		return HRATE_HE_NSS4_MCS5;
	} else if (!strcmp(str, "HE4MCS6")) {
		return HRATE_HE_NSS4_MCS6;
	} else if (!strcmp(str, "HE4MCS7")) {
		return HRATE_HE_NSS4_MCS7;
	} else if (!strcmp(str, "HE4MCS8")) {
		return HRATE_HE_NSS4_MCS8;
	} else if (!strcmp(str, "HE4MCS9")) {
		return HRATE_HE_NSS4_MCS9;
	} else if (!strcmp(str, "HE4MCS10")) {
		return HRATE_HE_NSS4_MCS10;
	} else if (!strcmp(str, "HE4MCS11")) {
		return HRATE_HE_NSS4_MCS11;
	}
	return 0;
}
