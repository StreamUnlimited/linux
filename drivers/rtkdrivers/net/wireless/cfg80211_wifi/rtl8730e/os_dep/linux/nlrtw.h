...
#else
static inline int rtw_nlrtw_init(void)
{
	return _FAIL;
}
static inline int rtw_nlrtw_deinit(void)
{
	return _FAIL;
}
static inline int rtw_nlrtw_ch_util_rpt(_adapter *adapter, u8 n_rpts, u8 *val, u8 **mac_addr)
{
	return _FAIL;
}
static inline int rtw_nlrtw_reg_change_event(_adapter *adapter)
{
	return _FAIL;
}
static inline int rtw_nlrtw_reg_beacon_hint_event(_adapter *adapter)
{
	return _FAIL;
}
static inline int rtw_nlrtw_radio_opmode_notify(struct rf_ctl_t *rfctl)
{
	return _FAIL;
}
...
#else
static inline int rtw_nlrtw_radar_detect_event(struct rf_ctl_t *rfctl, u8 band_idx, u8 cch, u8 bw)
{
	return _FAIL;
}
static inline int rtw_nlrtw_cac_finish_event(struct rf_ctl_t *rfctl, u8 band_idx, u8 cch, u8 bw)
{
	return _FAIL;
}
static inline int rtw_nlrtw_cac_abort_event(struct rf_ctl_t *rfctl, u8 band_idx, u8 cch, u8 bw)
{
	return _FAIL;
}
static inline int rtw_nlrtw_nop_finish_event(struct rf_ctl_t *rfctl, u8 band_idx, u8 band, u8 cch, u8 bw)
{
	return _FAIL;
}
static inline int rtw_nlrtw_nop_start_event(struct rf_ctl_t *rfctl, u8 band_idx, u8 band, u8 cch, u8 bw)
{
	return _FAIL;
}
