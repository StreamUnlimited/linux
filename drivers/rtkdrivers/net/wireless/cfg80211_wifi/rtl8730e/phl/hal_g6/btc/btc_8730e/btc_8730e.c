...
static struct btc_chip_ops btc_8730e_ops = {
	...
	_8730e_wl_tx_power,
	_8730e_wl_rx_gain,
	_8730e_wl_s1_standby,
	_8730e_wl_req_mac,
	_8730e_update_bt_cnt,
	_8730e_bt_rssi
};

/* Set  WL/BT periodical moniter reg, Max size: CXMREG_MAX*/
static struct fbtc_mreg btc_8730e_mon_reg[] = {
	{REG_MAC, 4, 0xda00},
	{REG_MAC, 4, 0xda04},
	{REG_MAC, 4, 0xda24},
	{REG_MAC, 4, 0xda30},
...
struct btc_rf_trx_para btc_8730e_rf_ul[] = {
...
struct btc_rf_trx_para btc_8730e_rf_dl[] = {
	{255, 0, 0, 7}, /* 0 -> original */
...
const struct btc_chip chip_8730e = {
	CHIP_WIFI6_8730E, /* chip id */
	0x0, /* chip para ver */
	0x6, /* desired bt_ver */
	...
	(u8)2, /* rssi tolerance */
	&btc_8730e_ops, /* chip-dependent function */
	ARRAY_SIZE(btc_8730e_mon_reg),
	btc_8730e_mon_reg, /* wl moniter register */
	ARRAY_SIZE(btc_8730e_rf_ul),
	btc_8730e_rf_ul,
	ARRAY_SIZE(btc_8730e_rf_dl),
	btc_8730e_rf_dl
};
...
void _8730e_set_wl_lna2(struct btc_t *btc, u8 level)
{
...
void _8730e_set_wl_trx_mask(struct btc_t *btc, u8 path, u8 group, u32 val)
{
...
void _8730e_init_cfg(struct btc_t *btc)
{
	...
	/* PTA init  */
	rtw_hal_mac_coex_init(h, chip_8730e.pta_mode, chip_8730e.pta_direction);
	...
	if (module->ant.type == BTC_ANT_SHARED) {
		_8730e_set_wl_trx_mask(btc, RF_PATH_A, BTC_BT_SS_GROUP, 0x5ff);
		_8730e_set_wl_trx_mask(btc, RF_PATH_B, BTC_BT_SS_GROUP, 0x5ff);
		/* set path-A(S0) Tx/Rx no-mask if GNT_WL=0 && BT_S1=tx group */
		_8730e_set_wl_trx_mask(btc, RF_PATH_A, BTC_BT_TX_GROUP, 0x5ff);
	} else { /* set WL Tx stb if GNT_WL = 0 && BT_S1 = ss group for 3-ant */
		_8730e_set_wl_trx_mask(btc, RF_PATH_A, BTC_BT_SS_GROUP, 0x5df);
		_8730e_set_wl_trx_mask(btc, RF_PATH_B, BTC_BT_SS_GROUP, 0x5df);
	}
