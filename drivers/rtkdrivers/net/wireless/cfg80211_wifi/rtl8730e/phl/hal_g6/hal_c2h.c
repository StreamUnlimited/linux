...
struct hal_c2h_hdl c2h_list[] = {
	{
		/* Temporarily give test C2H to mac process. */
		C2H_CAT_TEST, C2H_CLS_MAC_MIN, C2H_CLS_MAC_MAX,
		rtw_hal_mac_process_c2h
	},
	{
		C2H_CAT_OUTSRC, C2H_CLS_MAC_MIN, C2H_CLS_MAC_MAX,
		rtw_hal_bb_process_c2h
	},
#ifdef CONFIG_BTCOEX
	{
		C2H_CAT_BTCOEX, C2H_CLS_MAC_MIN, C2H_CLS_MAC_MAX,
