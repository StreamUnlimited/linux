...
struct hal_io_ops {
	...
	u16(*_sys_read16)(struct rtw_hal_com_t *hal, u32 base, u32 addr);
	u32(*_sys_read32)(struct rtw_hal_com_t *hal, u32 base, u32 addr);

	int (*_sys_write8)(struct rtw_hal_com_t *hal, u32 base, u32 addr, u8 val);
	int (*_sys_write16)(struct rtw_hal_com_t *hal, u32 base, u32 addr, u16 val);
	int (*_sys_write32)(struct rtw_hal_com_t *hal, u32 base, u32 addr, u32 val);
...
#define HAL_PPDU_PHYSTS BIT(1)
#define HAL_PHYSTS_PER_SUBMPDU BIT(3)
...
#if defined(CONFIG_PCI_HCI) || defined(CONFIG_AXI_HCI) /*TODO move to hal_info_t*/
	/*interrupt*/
	u32 int_array[4];
	u32 int_mask[4];
