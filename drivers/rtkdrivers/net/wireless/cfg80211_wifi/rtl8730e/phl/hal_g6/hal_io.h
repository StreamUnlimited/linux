...
extern u16 _hal_sys_read16(struct rtw_hal_com_t *hal, u32 base, u32 addr);
extern u32 _hal_sys_read32(struct rtw_hal_com_t *hal, u32 base, u32 addr);

extern int _hal_sys_write8(struct rtw_hal_com_t *hal, u32 base, u32 addr, u8 val);
extern int _hal_sys_write16(struct rtw_hal_com_t *hal, u32 base, u32 addr, u16 val);
extern int _hal_sys_write32(struct rtw_hal_com_t *hal, u32 base, u32 addr, u32 val);
...
#ifdef CONFIG_AXI_HCI
extern u8 dbg_sys_hal_read8(struct rtw_hal_com_t *hal, u32 base, u32 addr, const char *caller, const int line);
extern u16 dbg_sys_hal_read16(struct rtw_hal_com_t *hal, u32 base, u32 addr, const char *caller, const int line);
extern u32 dbg_sys_hal_read32(struct rtw_hal_com_t *hal, u32 base, u32 addr, const char *caller, const int line);

extern int dbg_sys_hal_write8(struct rtw_hal_com_t *hal, u32 base, u32 addr, u8 val, const char *caller, const int line);
extern int dbg_sys_hal_write16(struct rtw_hal_com_t *hal, u32 base, u32 addr, u16 val, const char *caller, const int line);
extern int dbg_sys_hal_write32(struct rtw_hal_com_t *hal, u32 base, u32 addr, u32 val, const char *caller, const int line);
#endif /* CONFIG_AXI_HCI */
...
#ifdef CONFIG_AXI_HCI
#define hal_sys_read8(hal, base, addr) dbg_hal_sys_read8((hal), (base), (addr), __FUNCTION__, __LINE__)
#define hal_sys_read16(hal, base, addr) dbg_hal_sys_read16((hal), (base), (addr), __FUNCTION__, __LINE__)
#define hal_sys_read32(hal, base, addr) dbg_hal_sys_read32((hal), (base), (addr), __FUNCTION__, __LINE__)

#define hal_sys_write8(hal, base, addr, val) dbg_hal_sys_write8((hal), (base), (addr), (val), __FUNCTION__, __LINE__)
#define hal_sys_write16(hal, base, addr, val) dbg_hal_sys_write16((hal), (base), (addr), (val), __FUNCTION__, __LINE__)
#define hal_sys_write32(hal, base, addr, val) dbg_hal_sys_write32((hal), (base), (addr), (val), __FUNCTION__, __LINE__)
#endif /* CONFIG_AXI_HCI */
...
#define hal_sys_read16(hal, base, addr) _hal_sys_read16((hal), (base), (addr))
#define hal_sys_read32(hal, base, addr) _hal_sys_read32((hal), (base), (addr))

#define  hal_sys_write8(hal, base, addr, val) _hal_sys_write8((hal), (base), (addr), (val))
#define  hal_sys_write16(hal, base, addr, val) _hal_sys_write16((hal), (base), (addr), (val))
#define  hal_sys_write32(hal, base, addr, val) _hal_sys_write32((hal), (base), (addr), (val))
#endif /* CONFIG_AXI_HCI */
