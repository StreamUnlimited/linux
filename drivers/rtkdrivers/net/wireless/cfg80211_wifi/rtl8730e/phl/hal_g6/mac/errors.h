...
#define MACEFUSEADDR	25 /* efuse address over max size */
...
#define MACMODEFAIL 133 /*wlan mode fail, not normal mode*/
#define MACTXFIFOPAGEFAIL  134  /*tx page allocate fail*/
#define MACINITLLTFAIL  135  /*init llt fail*/
#define MACOUTINDEX   136  /*index out of expected*/
