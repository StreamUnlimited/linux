...
*/
#define FWCMD_H2C_RSVDPAGE_CMDID				0x00

#define FWCMD_H2C_JOININFO_CMDID				0x01
#define FWCMD_H2C_JOININFO_CMDID_SH				0
#define FWCMD_H2C_JOININFO_CMDID_MSK				0xFF
#define FWCMD_H2C_JOININFO_OPMODE				BIT(0)
#define FWCMD_H2C_JOININFO_MACID_IND				BIT(1)
#define FWCMD_H2C_JOININFO_MIRACAST				BIT(2)
#define FWCMD_H2C_JOININFO_MIRACAST_ROLE			BIT(3)
#define FWCMD_H2C_JOININFO_MACID_DEST_ROLE_SH			4
#define FWCMD_H2C_JOININFO_MACID_DEST_ROLE_MSK			0X0F
...
struct fwcmd_rsvdpage {
	u8 cmd_id;	// 0x00
	u8 data0;	// loc_probersp
	u8 data1;	// loc_pspoll
	u8 data2;	// loc_nulldata
	u8 data3;	// loc_QosNull
	u8 data4;	// loc_bt_QosNull
	u8 data5;	// loc_CTS2Self
