...
/* REG dump*/
#define MAC_BASE 0x40000000
#define BB_BASE (0x40010000 - MAC_BASE)
#define RF_BASE (0x40017000 - MAC_BASE)
/*page 0~7, 1 page 256bytes*/
#define MAC_PAGE_SRT		0x0
#define MAC_PAGE_END        0x7
/*page 11/12/14/15/16/17/26*/
#define MAC_EXT_PAGE_SRT    0x11
#define MAC_EXT_PAGE_END    0x17
#define BB_PAGE_SRT_0		0x0
#define BB_PAGE_END_0		0x4
#define BB_PAGE_SRT_1		0x6
#define BB_PAGE_END_1		0xD
#define BB_PAGE_SRT_2		0x10
#define BB_PAGE_END_2		0x13
#define BB_PAGE_SRT_3		0x17
#define BB_PAGE_END_3		0x24
#define BB_PAGE_SRT_4		0x39
#define BB_PAGE_END_4		0x4F
#define BB_PAGE_SRT_5		0x58
#define BB_PAGE_END_5		0x6F
#define IQK_PAGE_SRT		0x1B
#define IQK_PAGE_END		0x1B
#define RFC_PAGE_SRT		0x0
#define RFC_PAGE_END		0x3

#define BA_CAM_MEM_SIZE      0x100
#define MBSSID_CAM_MEM_SIZE  0x80
#define SECURITY_CAM_MEM_SIZE 0x800
#define TX_BUFFER_SIZE         0x8000
#define RX_BUFFER_SIZE         0x4000
#define TXRPT_BUFFER_SIZE      0xC00
#define PHYSTS_BUFFER_SIZE     0x800
#define CHINFO_BUFFER_SIZE     0x400
#define DFS_BUFFER_SIZE        0x200
#define IQ_DUMP_BUFFER_SIZE    0x10000

#define TX_BUF_BASE        (0x40020000 - MAC_BASE)
#define RX_BUF_BASE        (0x40030000 - MAC_BASE)
#define TXRPT_BUF_BASE     (0x40040000 - MAC_BASE)
#define IQ_BASE            (0x20020000 - MAC_BASE)
#define PHYSTS_BUF_BASE    (0x40054000 - MAC_BASE)
#define CHINFO_BUF_BASE    (0x40052000 - MAC_BASE)
#define DFS_BUF_BASE       (0x40052600 - MAC_BASE)
#define SEC_CAM_BASE       (0x40050800 - MAC_BASE)
#define BA_CAM_BASE        (0x40051000 - MAC_BASE)
#define MBSSID_CAM_BASE    (0x40051800 - MAC_BASE)

#define MAC_AX_RX_CNT_NUM 63
#define MAC_AX_RX_CNT_IDX_MAX MAC_AX_RX_CNT_NUM
#define MAC_AX_RX_CNT_TYPE_NUM 4

/* the order is CCK, OFDM, HT, VHTSU, VHTMU, HESU, HEMU, HETB */
#define MAC_AX_RXCRC_OK_IDX \
	{3, 0, 6, 16, 21, 25, 29, 34}
#define MAC_AX_RXCRC_FAIL_IDX \
	{4, 1, 7, 17, 22, 26, 30, 35}
#define MAC_AX_RXPPDU_IDX \
	{MAC_AX_RX_CNT_IDX_MAX, MAC_AX_RX_CNT_IDX_MAX, 8, 18, 23, 27, 31, 36}
#define MAC_AX_RXFA_IDX \
	{5, 2, 9, 19, 24, 28, 32, 37}
