...
#define REG_PWC  0x000
#define PWC_AON_OTP BIT(0)
...
#define WLAFE_BASE  (0x42008940 - SYSTEM_CTRL_BASE_LP)
#define WLAFE_ANAPAR_POW_MAC_0  (WLAFE_BASE + 0x0)
#define HW_EN_WLRF  BIT(5)
...
#define ANAPAR_XTAL_ON_2  (XTAL_REG_BASE + 0x00C)
#define BIT_SHIFT_AAC_MODE				0
#define BIT_MASK_AAC_MODE				0x03
...
#define ANAPAR_XTAL_ON_0    (XTAL_REG_BASE + 0x04)
...
#define XTAL_ANAPAR_POW_XTAL_0 (XTAL_REG_BASE + 0x00)
#define XTAL_ANAPAR_XTAL_ON_0 (XTAL_REG_BASE + 0x04)
#define XTAL_ANAPAR_XTAL_ON_1 (XTAL_REG_BASE + 0x08)
#define XTAL_ANAPAR_XTAL_ON_2 (XTAL_REG_BASE + 0x0C)
#define XTAL_ANAPAR_XTAL_OFF_0 (XTAL_REG_BASE + 0x10)
#define XTAL_ANAPAR_XTAL_OFF_1 (XTAL_REG_BASE + 0x14)
#define XTAL_ANAPAR_XTAL_OFF_2 (XTAL_REG_BASE + 0x18)
#define XTAL_FEN (XTAL_REG_BASE + 0x1C)
#define XTAL_ANAPAR_XTAL_PDCK (XTAL_REG_BASE + 0x20)
#define XTAL_ANAPAR_XTAL_AAC (XTAL_REG_BASE + 0x24)
#define XTAL_ANAPAR_XTAL_AAC_ON_1 (XTAL_REG_BASE + 0x28)
#define XTAL_ANAPAR_XTAL_MODE_DEC_ON_0 (XTAL_REG_BASE + 0x2C)
#define XTAL_ANAPAR_XTAL_MODE_DEC_ON_1 (XTAL_REG_BASE + 0x30)
#define XTAL_DEBUG (XTAL_REG_BASE + 0x34)
#define XTAL_ART_CKON_TIM (XTAL_REG_BASE + 0x38)

#define WLAFE_ANAPAR_MAC_0 (WLAFE_BASE + 0x04)
#define WLAFE_ANAPAR_MAC_1 (WLAFE_BASE + 0x08)
#define WLAFE_ANAPAR_MAC_2 (WLAFE_BASE + 0x0C)
#define WLAFE_DBG_WLAFE_PMC (WLAFE_BASE + 0x10)
#define WLAFE_DBG_WLAFE (WLAFE_BASE + 0x14)
#define WLAFE_ANAPAR_RFC (WLAFE_BASE + 0x20)
#define WLAFE_LDO_VPLUSE_SEL (WLAFE_BASE + 0x24)
#define WLAFE_WLRFC_CTRL (WLAFE_BASE + 0x28)
#define WLAFE_ANAPAR_DCK_0 (WLAFE_BASE + 0x2C)
...
#define OTP_BASE  0x42000000
#define REG_OTP_AS  0x008
#define REG_OTP_AS_SEC  0x00C
#define REG_OTP_CTRL  0x014
...
#define PLTFM_SYS_REG_R16(base, addr)                                          \
	adapter->pltfm_cb->sys_reg_r16(adapter->drv_adapter, base, addr)
#define PLTFM_SYS_REG_R32(base, addr)                                          \
	adapter->pltfm_cb->sys_reg_r32(adapter->drv_adapter, base, addr)
#define PLTFM_SYS_REG_W8(base, addr, val)                                      \
	adapter->pltfm_cb->sys_reg_w8(adapter->drv_adapter, base, addr, val)
#define PLTFM_SYS_REG_W16(base, addr, val)                                      \
	adapter->pltfm_cb->sys_reg_w16(adapter->drv_adapter, base, addr, val)
#define PLTFM_SYS_REG_W32(base, addr, val)                                      \
	adapter->pltfm_cb->sys_reg_w32(adapter->drv_adapter, base, addr, val)
#endif
...
#define SYS_REG_R8(base, addr)                                                 \
	ops->sys_reg_read8(adapter, base, addr)
#define SYS_REG_R16(base, addr)                                            \
	ops->sys_reg_read16(adapter, base, addr)
#define SYS_REG_R32(base, addr)                                            \
	ops->sys_reg_read32(adapter, base, addr)
#define SYS_REG_W8(base, addr, val)                                        \
	ops->sys_reg_write8(adapter, base, addr, val)
#define SYS_REG_W16(base, addr, val)                                       \
 ...
 * Please Place Description here.
 * @var mac_ax_hw_id::MAC_AX_HW_SET_FAST_EDCA_PARAM
 * Please Place Description here.
...
enum mac_ax_mem_sel {
	MAC_AX_MEM_TX_BUF,
	MAC_AX_MEM_RX_BUF,
	MAC_AX_MEM_TXRPT_BUF,
	MAC_AX_MEM_IQ_BUF,
	MAC_AX_MEM_PHYSTS_BUF,
	MAC_AX_MEM_CHINFO_BUF,
	MAC_AX_MEM_DFS_BUF,
	MAC_AX_MEM_SECURITY_CAM,
	MAC_AX_MEM_MBSSID_CAM,
	MAC_AX_MEM_BA_CAM,
 ...
 */
enum mac_ax_slot_time {
	MAC_AX_SLOT_TIME_9US,
	MAC_AX_SLOT_TIME_20US,
};
 ...
 * Please Place Description here.
 */
/* H2C Command JOININFO: Macid_Dest_Role: The role of this macid destination. */
/* 0: rsvd  1: Client.  2: AP  3: P2PGC.  4: P2PGO.  5: TDLS  6: adhoc  7:mesh */
enum mac_ax_wifi_role {
...
enum mac_ax_la_mode {
	HALMAC_LA_MODE_DUMP_BB = 0,
	HALMAC_LA_MODE_DUMP_TXD = 1,
	HALMAC_LA_MODE_DUMP_RXD = 2,
	HALMAC_LA_MODE_UNDEFINE = 0x7F,
};

enum max_ax_la_mode_tri_stop {
	MACTRX_TRIG_STOP = 0,
	MAC_DEBUG_PORT = 1,
	MAC_TXDRXD = 2,
};
...
struct mac_ax_hw_info {
	...
	enum mac_ax_drv_info_size mac_drv_info;
...
struct mac_ax_fw_info {
	...
	u8 h2c_seq;
	u8 rec_seq;
	u8 last_hmebox_num; /* H2C - for host message to fw */
 ...
 */
struct mac_ax_la_cfg {
	enum mac_ax_la_mode la_mode;
	enum max_ax_la_mode_tri_stop trig_stop;
	u32 mac_tx_trig_stop_val: 5;
	u32 mac_rx_trig_stop_val: 5;
	u32 debug_port_trig_stop_mask;
	u32 debug_port_trig_stop_ref;
	u32 txd_trig_stop_mask_l;
	u32 txd_trig_stop_mask_h;
	u32 txd_trig_stop_ref_l;
	u32 txd_trig_stop_ref_h;
	u32 la_restart_en: 1;
	/*00: level signal   01: posedge  10: negdge*/
	u32 trig_level_sel: 2;
	/*length break*/
	u32 la_tri_len_bk: 1;
	/* 0: 1us  001: 2us  010: 4us  011: 8us */
	u32 la_tgr_tu_sel: 3;
...
/* User only can use  Address[6]*//* Address[0] is lowest, Address[5] is highest */
...
#if MAC_AX_PCIE_SUPPORT    //#if !MAC_AX_PCIE_SUPPORT  jerry_zhou
struct tx_base_desc {
	u8 *vir_addr;
	u32 phy_addr_l;
	u32 phy_addr_h;
...
struct mac_ax_rx_fltr_ctrl_t {
	...
	u8 acpt_add3: 1;
	u8 acpt_apwrmgt: 1;
	u8 chk_cbssid_data: 1;
	u8 chk_cbssid_mgnt: 1;
	//u8 acpt_pwr_mgnt_pkt: 1;
	u8 acpt_acrc32: 1;
	u8 acpt_aicv: 1;
	u8 chk_ta_mgnt: 1;
	u8 acpt_ack_cbssid: 1;
};
...
/**
 * @struct mac_ax_axi_info
 * @brief mac_ax_axi_info
 *
 * @var mac_ax_axi_info::txbd_bndy
 * Please Place Description here.
 */
struct mac_ax_axi_info {
	u16 txbd_bndy;
...
/**
 * @struct mac_ax_csi_rrsr_cfg
 * @brief mac_ax_csi_rrsr_cfg
 *
...
struct mac_ax_csi_rrsr_cfg {
	u32 csi_rrsr_opt: 1;
	u32 csi_rrsr_he_cfg: 9;
	u32 csi_rrsr_vht_cfg: 9;
	u32 csi_rrsr_ht_cfg: 9;
	u32 csi_force_en: 1;
	u32 csi_rrsr_ofdm_mask: 8;
	u32 csi_rrsr_ht_mask: 8;
	u32 csi_rrsr_vht_mask: 8;
	u32 csi_rrsr_he_mask: 8;
	u32 rsc: 2;
	u32 rsvd: 5;
};
 ...
 */
struct mac_ax_coex_gnt {
	struct mac_ax_gnt band;
	enum btc_gnt_setup_state state;
};
 ...
 */
struct mac_ax_tx_cnt {
#define MAC_AX_TX_HT_MSDU 4
#define MAC_AX_TX_VHT_SU_MSDU 5
#define MAC_AX_TX_HE_SU_MSDU 6
#define MAC_AX_TX_HE_TB_MSDU 7
#define MAC_AX_TX_CCK 8
#define MAC_AX_TX_OFDM 9
#define MAC_AX_TX_HT_PPDU 10
#define MAC_AX_TX_VHT_SU_PPDU 11
#define MAC_AX_TX_HE_SU_PPDU 12
#define MAC_AX_TX_HE_TB_PPDU 13
#define MAC_AX_TX_ALLTYPE 10
	u8 sel;
...
struct mac_ax_pltfm_cb {
	...
	void (*sys_reg_w8)(void *drv_adapter, u32 base, u32 addr, u8 val);
	void (*sys_reg_w16)(void *drv_adapter, u32 base, u32 addr, u16 val);
	void (*sys_reg_w32)(void *drv_adapter, u32 base, u32 addr, u32 val);
#endif
#if MAC_AX_PHL_H2C
...
#endif
#if MAC_AX_AXI_SUPPORT
	struct mac_ax_axi_info axi_info;
#endif
...
struct mac_ax_intf_ops {
	...
	u8(*sys_reg_read8)(struct mac_ax_adapter *adapter, u32 base, u32 addr);
	void (*sys_reg_write8)(struct mac_ax_adapter *adapter, u32 base, u32 addr, u8 val);
	u16(*sys_reg_read16)(struct mac_ax_adapter *adapter, u32 base, u32 addr);
	void (*sys_reg_write16)(struct mac_ax_adapter *adapter, u32 base, u32 addr, u16 val);
	u32(*sys_reg_read32)(struct mac_ax_adapter *adapter, u32 base, u32 addr);
	void (*sys_reg_write32)(struct mac_ax_adapter *adapter, u32 base, u32 addr, u32 val);
	/**
	 * @tx_allow_sdio
...
struct mac_ax_ops {
	...
	u32(*sta_search_key_idx)(struct mac_ax_adapter *adapter,
				 u8 mac_id, u8 key_id, u8 key_type);
	u32(*write_security_cam)(struct mac_ax_adapter *adapter, u32 idx,
	...
	u32(*outsrc_h2c_common)(struct mac_ax_adapter *adapter,
				...
				u32 *pvalue);
	u32(*read_pwr_reg)(struct mac_ax_adapter *adapter,
			   const u32 offset, u32 *val);
	u32(*write_pwr_reg)(struct mac_ax_adapter *adapter,
			    const u32 offset, u32 val);
	u32(*write_msk_pwr_reg)(struct mac_ax_adapter *adapter,
	...
	/*sounding related*/
	u32(*get_csi_buffer_index)(struct mac_ax_adapter *adapter,
				   u8 csi_buffer_id);
	u32(*set_csi_buffer_index)(struct mac_ax_adapter *adapter,
				   u16 csi_buffer_id);
	...
	u32(*csi_force_rate)(struct mac_ax_adapter *adapter,
			     u8 ht_rate, u8 vht_rate, u8 he_rate);
	u32(*csi_rrsc)(struct mac_ax_adapter *adapter, u32 rrsc);
	...
	u32(*deinit_mee)(struct mac_ax_adapter *adapter);
	...
	u32(*dump_efuse_map)(struct mac_ax_adapter *adapter,
			     u8 *efuse_map);
	...
	u32(*dump_log_efuse)(struct mac_ax_adapter *adapter, u8 *efuse_map);
