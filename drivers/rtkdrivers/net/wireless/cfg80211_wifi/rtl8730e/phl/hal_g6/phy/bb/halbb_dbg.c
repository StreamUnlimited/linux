...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		halbb_dbgport_dump_all_8730e(bb, _used, output, _out_len);
		break;
#endif
	default:
		break;
...
void halbb_basic_dbg_01_system(struct bb_info *bb)
{
	...
	BB_DBG(bb, DBG_CMN, "physts_cnt{all, 2_self, err_len, ok_ie, err_ie}={%d,%d,%d,%d,%d}, invalid_he=%d\n",
...
#if 0//AX_TODO, iot not use para from file
...
void halbb_cr_cfg_dbg_init(struct bb_info *bb)
{
	...
	case BB_CLIENT:
		...
		cr->path_0_txpw = PATH0_R_TXPWR_00_C;
		cr->path_0_txpw_m = PATH0_R_TXPWR_00_C_M;
#else
