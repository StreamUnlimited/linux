...
bool halbb_fw_set_gain_error_8852a_2(struct bb_info *bb, u8 central_ch)
{
	...
	s32 tmp = 0;
	u32 lna_err_a_5g[BB_PATH_MAX_8852A][7] = {{
			0x462c, 0x462c, 0x4630,
	...
	u32 lna_err_a_2g[BB_PATH_MAX_8852A][7] = {{
			0x462c, 0x4630, 0x4630,
			0x4634, 0x4634, 0x4638,
			0x463c
		}, {
			0x4700, 0x4704,
	...
	u32 tia_err_a_5g[BB_PATH_MAX_8852A][2] = {{0x4640, 0x4644}, {
			0x4714,
			0x4718
		}
	};
	u32 tia_err_a_5g_mask[2] = {0x0003f000, 0x0000003f};
	u32 tia_err_a_2g[BB_PATH_MAX_8852A][2] = {{0x4640, 0x4644}, {
			0x4714,
			0x4718
		}
	};
