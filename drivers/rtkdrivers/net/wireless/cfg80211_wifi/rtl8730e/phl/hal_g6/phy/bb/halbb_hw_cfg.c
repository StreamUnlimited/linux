			   ...
			   u32 *folder_array, enum phl_phy_idx phy_idx)
{
	...
	case BB_RTL8720E:
		result = halbb_cfg_bbcr_ax_8720e(bb, is_form_folder, folder_len,
						 folder_array, phy_idx);
		halbb_tpu_mac_cr_init(bb, phy_idx);
		halbb_tssi_ctrl_mac_cr_init(bb, phy_idx);
		break;
	...
	case BB_RTL8730E:
		result = halbb_cfg_bbcr_ax_8730e(bb, is_form_folder, folder_len,
						 folder_array, phy_idx);
		halbb_tpu_mac_cr_init(bb, phy_idx);
		halbb_tssi_ctrl_mac_cr_init(bb, phy_idx);
		break;
...
#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		result &= halbb_cfg_bb_gain_ax_8720e(bb, is_form_folder,
						     folder_len, folder_array);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		result &= halbb_cfg_bb_gain_ax_8730e(bb, is_form_folder,
						     folder_len, folder_array);
		break;
#endif
...
bool halbb_init_reg(struct bb_info *bb)
{
	...
	bool rpt_0 = true;
	bool rpt_gain = true;
	bool is_form_folder = false;
	u32 folder_len = 0;
	u32 folder_array[1] = {0};

	rpt_0 = halbb_init_cr_default(bb, is_form_folder, folder_len, folder_array, HW_PHY_0);
	rpt_gain = halbb_init_gain_table(bb, is_form_folder, folder_len, folder_array, HW_PHY_0);

	BB_DBG(bb, DBG_INIT, "phy0/gain success: {%d, %d}\n", rpt_0, rpt_gain);
