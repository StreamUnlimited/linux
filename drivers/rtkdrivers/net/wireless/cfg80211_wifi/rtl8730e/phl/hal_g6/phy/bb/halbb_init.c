...
void halbb_ic_hw_setting_init(struct bb_info *bb)
{
	...
	case BB_RTL8730E:
		halbb_ic_hw_setting_init_8730e(bb);
	...
	case BB_RTL8720E:
		halbb_ic_hw_setting_init_8720e(bb);
#ifdef HALBB_DYN_CSI_RSP_SUPPORT
		halbb_dcr_init(bb);
#endif
		break;
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		halbb_get_normal_efuse_init_8730e(bb);
		halbb_get_hidden_efuse_init_8730e(bb);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		halbb_get_normal_efuse_init_8720e(bb);
		halbb_get_hidden_efuse_init_8720e(bb);
		break;
#endif
...
#endif
#ifdef BB_8730E_SUPPORT
	} else if (hal_i->chip_id == CHIP_WIFI6_8730E) {
		bb->ic_type = BB_RTL8730E;
		bb->ic_sub_type = BB_IC_SUB_TYPE_8730E_8730E;
#endif
#ifdef BB_8720E_SUPPORT
	} else if (hal_i->chip_id == CHIP_WIFI6_8720E) {
		bb->ic_type = BB_RTL8720E;
		bb->ic_sub_type = BB_IC_SUB_TYPE_8720E_8720E;
#endif
