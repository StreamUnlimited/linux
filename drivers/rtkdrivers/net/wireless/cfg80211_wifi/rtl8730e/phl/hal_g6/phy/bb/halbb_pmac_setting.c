		       ...
		       enum phl_phy_idx phy_idx)
{
	...
	case BB_RTL8730E:
		halbb_set_pmac_tx_8730e(bb, tx_info, phy_idx);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		halbb_set_pmac_tx_8720e(bb, tx_info, phy_idx);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		halbb_set_tmac_tx_8730e(bb, phy_idx);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		halbb_set_tmac_tx_8720e(bb, phy_idx);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		rpt = halbb_set_txpwr_dbm_8730e(bb, pwr_dbm, phy_idx);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		rpt = halbb_set_txpwr_dbm_8720e(bb, pwr_dbm, phy_idx);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		rpt = halbb_get_txpwr_dbm_8730e(bb, phy_idx);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		rpt = halbb_get_txpwr_dbm_8720e(bb, phy_idx);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		rpt = halbb_get_txinfo_txpwr_dbm_8730e(bb);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		rpt = halbb_get_txinfo_txpwr_dbm_8720e(bb);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		rpt = halbb_set_cck_txpwr_idx_8730e(bb, pwr_idx, tx_path);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		rpt = halbb_set_cck_txpwr_idx_8720e(bb, pwr_idx, tx_path);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		rpt = halbb_get_cck_txpwr_idx_8730e(bb, tx_path);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		rpt = halbb_get_cck_txpwr_idx_8720e(bb, tx_path);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		rpt = halbb_get_cck_ref_dbm_8730e(bb, tx_path);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		rpt = halbb_get_cck_ref_dbm_8720e(bb, tx_path);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		rpt = halbb_set_ofdm_txpwr_idx_8730e(bb, pwr_idx, tx_path);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		rpt = halbb_set_ofdm_txpwr_idx_8720e(bb, pwr_idx, tx_path);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		rpt = halbb_get_ofdm_txpwr_idx_8730e(bb, tx_path);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		rpt = halbb_get_ofdm_txpwr_idx_8720e(bb, tx_path);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		rpt = halbb_get_ofdm_ref_dbm_8730e(bb, tx_path);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		rpt = halbb_get_ofdm_ref_dbm_8720e(bb, tx_path);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		halbb_backup_info_8730e(bb, phy_idx);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		halbb_backup_info_8720e(bb, phy_idx);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		halbb_restore_info_8730e(bb, phy_idx);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		halbb_restore_info_8720e(bb, phy_idx);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		rpt = halbb_set_txsc_8730e(bb, txsc, phy_idx);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		rpt = halbb_set_txsc_8720e(bb, txsc, phy_idx);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		rpt = halbb_set_bss_color_8730e(bb, bss_color, phy_idx);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		rpt = halbb_set_bss_color_8720e(bb, bss_color, phy_idx);
		break;
#endif
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		rpt = halbb_set_sta_id_8730e(bb, sta_id, phy_idx);
		break;
#endif

#ifdef BB_8720E_SUPPORT
	case BB_RTL8720E:
		rpt = halbb_set_sta_id_8720e(bb, sta_id, phy_idx);
		break;
#endif
