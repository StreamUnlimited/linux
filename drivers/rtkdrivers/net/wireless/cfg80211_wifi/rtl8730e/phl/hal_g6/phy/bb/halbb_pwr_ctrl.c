			      ...
			      enum phl_phy_idx phy_idx)
{
	...
	case BB_RTL8730E:
		halbb_set_pwr_ul_tb_ofst_8730e(bb, (s8)pw_ofst, phy_idx);
		break;
#endif
...

{
	u32 tpu_array_type1[] = {0xD248, 0x07763333,
				 0xD220, 0x01ebf000,
				 0xD240, 0x000340ff
				};/* Ameba Lite min_power:-33dbm -> -24dbm */
	u32 *tpu_array = NULL;
	u8 cr_size = 0;
	u8 i = 0;
	...
	switch (bb->ic_type) {
	    ...
	    defined(BB_8730E_SUPPORT) || defined(BB_8720E_SUPPORT)
	case BB_RTL8852A:
	case BB_RTL8852B:
	case BB_RTL8852C:
	case BB_RTL8192XB:
...
#ifdef BB_8730E_SUPPORT
	case BB_RTL8730E:
		halbb_tssi_ctrl_set_dbw_table_8730e(bb);
		break;
#endif
	default:
		break;
