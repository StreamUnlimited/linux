...
# Level 2 directory
path_halrf_8730e := $(path_halrf_d1)/halrf_$(rf_ic)

halrf-y += $(path_halrf_8730e)/halrf_8730e.o \
			$(path_halrf_8730e)/halrf_txgapk_8730e.o \
			$(path_halrf_8730e)/halrf_8730e_api.o \
			$(path_halrf_8730e)/halrf_8730e.o \
			...
			$(path_halrf_8730e)/halrf_efuse_8730e.o\
			$(path_halrf_8730e)/halrf_tssi_8730e.o\
			$(path_halrf_8730e)/halrf_kfree_8730e.o\
			$(path_halrf_8730e)/halrf_psd_8730e.o
endif

ifeq ($(CONFIG_RTL8720E), y)
rf_ic := 8720e

# Level 2 directory
path_halrf_8720e := $(path_halrf_d1)/halrf_$(rf_ic)

halrf-y += $(path_halrf_8720e)/halrf_8720e.o \
			$(path_halrf_8720e)/halrf_8720e.o \
			...
			$(path_halrf_8720e)/halrf_efuse_8720e.o\
