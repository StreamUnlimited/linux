 ...
 *
 *****************************************************************************/
#ifndef _RTL8730E_HAL_H_
#define _RTL8730E_HAL_H_
#include "../hal_headers.h"

/*usage under rtl8730e folder*/
#include "rtl8730e_spec.h"
#include "hal_trx_8730e.h"

#ifdef CONFIG_AXI_HCI
#include "axi/rtl8730ea_hal.h"
#endif

enum hw_stype_8730e {
	EFUSE_HW_STYPE_NONE_8730E = 0,
	EFUSE_HW_STYPE_VF1_CG_8730E = 0xe,
	EFUSE_HW_STYPE_GENERAL_8730E = 0xf
};
...
enum rtw_hal_status hal_cfg_fw_8730e(struct rtw_phl_com_t *phl_com,
				     struct hal_info_t *hal,
				     char *ic_name,
...
enum rtw_hal_status hal_start_8730e(struct rtw_phl_com_t *phl_com,
				    struct hal_info_t *hal,
				    struct hal_init_info_t *init_info);
enum rtw_hal_status hal_stop_8730e(struct rtw_phl_com_t *phl_com,
				   struct hal_info_t *hal);
