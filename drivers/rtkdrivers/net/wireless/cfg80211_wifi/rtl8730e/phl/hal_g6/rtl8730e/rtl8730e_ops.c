 ...
 *
 *****************************************************************************/
#define _RTL8730E_OPS_C_
#include "../hal_headers.h"
#include "rtl8730e_hal.h"

static void read_chip_version_8730e(struct rtw_phl_com_t *phl_com,
...
void hal_set_ops_8730e(struct rtw_phl_com_t *phl_com,
		       struct hal_info_t *hal)
{
	struct hal_ops_t *ops = hal_get_ops(hal);

	/*** initialize section ***/
	ops->read_chip_version = read_chip_version_8730e;
...
#ifdef RTW_PHL_BCN
	ops->cfg_bcn = hal_config_beacon_8730e;
	ops->upt_bcn = hal_update_beacon_8730e;
#endif
...
#if 0
void hal_set_trx_ops_8730e(struct hal_info_t *hal)
{
	struct hal_trx_ops_t *ops = hal_get_trx_ops(hal);

	ops->get_txdesc_len = get_txdesc_len_8730e;
	ops->fill_txdesc_h2c = fill_txdesc_h2c_8730e;
	ops->fill_txdesc_fwdl = fill_txdesc_fwdl_8730e;
	ops->fill_txdesc_pkt = fill_txdesc_pkt_8730e;
}
#endif
