...
#define MAX_PHL_RING_RX_PKT_NUM 64
...
struct rtw_r_meta_data {
	...
	u8 crc32;		/* DW0 [14:14] */
	u8 icverr;		/* DW0 [15:15] */
	u8 sniffer_len;		/* DW0 [16:18] */
	u8 eosp;		/* DW0 [19:19] */
	u8 sec_type;		/* DW0 [20:22] */
	u8 shift;		/* DW0 [23:24] */
	u8 sw_dec;		/* DW0 [25:25] */
	u8 rx_he_mu_ru_size;	/* DW0 [28:26] */
	u8 bw;			/* DW0 [29:30] */
	u8 inter_ppdu;		/* DW0 [31:31] */
	u16 macid;		/* DW0 [32:38] */
	u8 ex_sec_type;		/* DW0 [39:39] */
	u8 tid;			/* DW0 [40:43] */
	u8 macid_vld;		/* DW0 [44:44] */
	u8 amsdu;		/* DW0 [45:45] */
	u8 rx_id_match;		/* DW0 [46:46] */
	u8 ampdu;		/* DW0 [47:47] */
	u8 rpkt_type;		/* DW0 [48:50] */
	u8 r_sent_rxcmd;	/* DW0 [51:51] */
	u8 chksum_err;		/* DW0 [52:52] */
	u8 ipv6;		/* DW0 [53:53] rx packet is IPV4 when value is 0, otherwise is IPV6 */
	u8 udp;			/* DW0 [54:54] rx packet is TCP when value is 0, otherwise is UDP packet */
	u8 data_chksum_en;	/* DW0 [55:55] */
	u8 a1_match;		/* DW0 [56:56] */
	u8 pwr_bit;		/* DW0 [57:57] */
	u8 more_data;		/* DW0 [58:58] */
	u8 more_frag;		/* DW0 [59:59] */
	u8 frame_type;		/* DW0 [60:61] */
	u8 mc;			/* DW0 [62:62] */
	u8 bc;			/* DW0 [63:63] */

	u16 seq;		/* DW1 [0:11] */
	u8 frag_num;		/* DW1 [12:15] */
	u8 qos;			/* DW1 [16:16] */
	u8 rx_statistics;	/* DW1 [17:17] */
	u8 wl_hd_iv_len;	/* DW1 [18:23] */
	u8 magic_pkt;		/* DW1 [24:24] */
	u8 rx_gi_ltf;		/* DW1 [25:27] */
	u8 c2h;			/* DW1 [28:28] */
	u8 ppdu_flush_cnt;	/* DW1 [29:30] */
	u8 fcs_ok;		/* DW1 [31:31] */
	u16 rx_rate;		/* DW1 [32:40] */
	u8 htc;			/* DW1 [41:41] */
	u8 rxmpdu_bssid_fit;	/* DW1 [42:43] */
	/* normal rx */
	u16 pwr_lv;		/* DW1 [44:52] */
	u16 central_ch;		/* DW1 [53:60] */
	/* channel info */
	u16 csi_len;		/* DW1 [48:57] */
	u8 rx_bw;		/* DW1 [58:59] */
	/* ppdu status */
	u16 sts_len;		/* DW1 [48:55] */
	u8 rx_is_data;		/* DW1 [56:56] */
	u8 pattern_wake;	/* DW1 [61:61] */
	u8 unicast_wake;	/* DW1 [62:62] */
	u8 magic_wake;		/* DW1 [63:53] */

	u8 pattern_idx;		/* DW2 [0:7] */
	u8 eof;			/* DW2 [8:8] */
	...
	u8 vendor_check;	/* DW2 [31:31] */
	u32 freerun_cnt;	/* DW2 [32:63] */
