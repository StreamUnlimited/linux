...
static const struct snd_kcontrol_new common_snd_controls[] = {
	SOC_DOUBLE_R_TLV("DAC Playback Volume", CODEC_DAC_L_CONTROL_0,
			 CODEC_DAC_R_CONTROL_0, 0, 0xaf, 0, digital_tlv),
	SOC_DOUBLE_R("DAC Mute Playback Switch", CODEC_DAC_L_CONTROL_1,
			 CODEC_DAC_R_CONTROL_1, 11, 0x1, 0),
	SOC_SINGLE("AD0 Capture Volume", CODEC_ADC_0_CONTROL_1, 0, 0xaf, 0),
	SOC_SINGLE("AD1 Capture Volume", CODEC_ADC_1_CONTROL_1, 0, 0xaf, 0),
	SOC_SINGLE("AD2 Capture Volume", CODEC_ADC_2_CONTROL_1, 0, 0xaf, 0),
	SOC_SINGLE("AD3 Capture Volume", CODEC_ADC_3_CONTROL_1, 0, 0xaf, 0),
	SOC_SINGLE("AD4 Capture Volume", CODEC_ADC_4_CONTROL_1, 0, 0xaf, 0),
	SOC_SINGLE("AD5 Capture Volume", CODEC_ADC_5_CONTROL_1, 0, 0xaf, 0),
	SOC_SINGLE("AD6 Capture Volume", CODEC_ADC_6_CONTROL_1, 0, 0xaf, 0),
	SOC_SINGLE("AD7 Capture Volume", CODEC_ADC_7_CONTROL_1, 0, 0xaf, 0),
