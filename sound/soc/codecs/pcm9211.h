...
/* PCM9211_NON_PCM_DEF */
#define PCM9211_NON_PCM_DTS_CD_DET_MASK	(BIT(2) | BIT(0))

/* PCM9211_INT0_CAUSE */
#define PCM9211_INT0_MERROR0_MASK	BIT(7)
#define PCM9211_INT0_MNPCM0_MASK	BIT(6)
#define PCM9211_INT0_MEMPHF0_MASK	BIT(5)
#define PCM9211_INT0_MDTSCD0_MASK	BIT(4)
#define PCM9211_INT0_MCSRNW0_MASK	BIT(3)
#define PCM9211_INT0_MPCRNW0_MASK	BIT(2)
#define PCM9211_INT0_MFSCHG0_MASK	BIT(1)
#define PCM9211_INT0_MADLVL1_MASK	BIT(0)

/* PCM9211_INT1_CAUSE */
#define PCM9211_INT1_MADLVL1_MASK	BIT(0)
...
#define PCM9211_BIPHASE_SCSBIT1_SHIFT	6
#define PCM9211_BIPHASE_SCSBIT1_MASK	BIT(PCM9211_BIPHASE_SCSBIT1_SHIFT)
...
/* PCM9211_DIT_CTRL2 */
#define PCM9211_DIT_TXSCK_SHIFT		4
#define PCM9211_DIT_TXSCK_MASK		(0x7 << PCM9211_DIT_TXSCK_SHIFT)
...
/* PCM9211_MPIO_B_MAIN_HIZ */
#define PCM9211_MPIO_B_HIZ_SHIFT	4
#define PCM9211_MPIO_B_HIZ_MASK		(0xf << PCM9211_MPIO_B_HIZ_SHIFT)
#define PCM9211_MAIN_HIZ_SHIFT		0
#define PCM9211_MAIN_HIZ_MASK		(0xf << PCM9211_MAIN_HIZ_SHIFT)

/* PCM9211_MPIO_C_MPIO_A_HIZ */
#define PCM9211_MPIO_C_HIZ_SHIFT	4
#define PCM9211_MPIO_C_HIZ_MASK		(0xf << PCM9211_MPIO_C_HIZ_SHIFT)
#define PCM9211_MPIO_A_HIZ_SHIFT	0
#define PCM9211_MPIO_A_HIZ_MASK		(0xf << PCM9211_MPIO_A_HIZ_SHIFT)
...
/* PCM9211_MAIN_AUX_MUTE */
#define PCM9211_MODMUT			(1)
