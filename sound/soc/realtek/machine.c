...
SND_SOC_DAILINK_DEFS(aif1,
	...
	DAILINK_COMP_ARRAY(COMP_CODEC("4100b000.codec", "amebad2-aif1")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("audiodma@0")));

SND_SOC_DAILINK_DEFS(aif2,
	DAILINK_COMP_ARRAY(COMP_CPU("4100e000.sport")),
	DAILINK_COMP_ARRAY(COMP_CODEC("4100b000.codec", "amebad2-aif2")),
...
static struct snd_soc_ops amebad2_ops = {
	.hw_params = amebad2_hw_params,
};

static struct snd_soc_dai_link amebad2_dai[] = {
	{
		.name = "codec AIF1",
		.stream_name = "Pri_Dai",
		.ops = &amebad2_ops,
...
static const struct of_device_id amebad2_audio_of_match[] = {
	{ .compatible = "realtek,amebad2-audio", },
	{},
};
MODULE_DEVICE_TABLE(of, amebad2_audio_of_match);


static struct platform_driver amebad2_audio_driver = {
	.driver		= {
		.name	= "amebad2-audio",
		.of_match_table = of_match_ptr(amebad2_audio_of_match),
		.pm	= &snd_soc_pm_ops,
	},
	.probe		= amebad2_audio_probe,
};

module_platform_driver(amebad2_audio_driver);
